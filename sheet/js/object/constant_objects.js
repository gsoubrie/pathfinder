OBJECT.CONST = {
    ...
    "plBGdZhqq5JBl1D8": {
        ...
        "description": "",
        "element_type": null,
        "href": "/equipment/plBGdZhqq5JBl1D8",
        "id": "plBGdZhqq5JBl1D8",
        "price": null,
        "required": [],
    ...
    "PVXqMko4yGgw90uo": {
        ...
        "description": "",
        "element_type": null,
        "href": "/equipment/PVXqMko4yGgw90uo",
        "id": "PVXqMko4yGgw90uo",
        "price": null,
        "required": [],
        "text": "désir du cœur",
    ...
    "Gcliatty0MGYbTVV": {
        ...
        "bulk": null,
        "category": "feat",
        "description": "<p>\"Déclencheur\" Vous êtes sur le poind de lancer l'initiative.</p>\n<p>Vous avez la prémonition d'un danger imminent que vous utilisez pour avertir vos alliés. Chaque allié dans un rayon de 6 mètres obtient un bonus de statut de +2 à son jet d'initiative et obtient des Points de vie temporaires égaux à la moitié de votre niveau, qui durent 1 minute. Si vous êtes  <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'zXZjC8HLaRoLR17U'})\">Lié à la malédiction 2</div>  lorsque vous utilisez Avertissement Oraculaire, le bonus passe à +3 et à +4 si vous êtes Lié à la malédiction 3.</p>\n<p><div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': '7XxZ4YJ6c97D9Fc9'})\">Effet : Avertissement oraculaire</div></p>",
        "element_type": "DON 1",
        "href": "/feats/Gcliatty0MGYbTVV",
        "id": "Gcliatty0MGYbTVV",
        "price": null,
        "required": [],
        "text": "Avertissement oraculaire",
        "traits": [
            "Audible",
    ...
    "3uh1r86TzbQvosxv": {
        ...
        "bulk": null,
        "category": "condition",
        "description": "<p>Votre âme a été saisie par une force puissante qui vous rapproche de la mort. Condamné est toujours accompagné d'une valeur. La valeur maximale de l'état  <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'yZRUzMqrMmfLu0V1'})\">Mourant</div>  à partir de laquelle vous mourez est diminuée de la valeur de votre état Condamné. Si la valeur maximale de l'état Mourant est réduite à 0, vous mourez instantanément. Lorsque vous mourez, vous perdez l'état Condamné.</p>\n<p>La valeur de votre état Condamné est diminuée de 1 à chaque fois que vous prenez une nuit de repos complet.</p>",
        "element_type": null,
        "href": "/conditions/3uh1r86TzbQvosxv",
        "id": "3uh1r86TzbQvosxv",
        "price": null,
        "required": [],
        "text": "Condamnée 1",
    ...
    "1xRFPTFtWtGJ9ELw": {
        ...
        "bulk": null,
        "category": "action",
        "description": "<p>Vous tentez de déterminer si le comportement d'une créature est anormal. Choisissez une créature et tentez de repérer un langage corporel étrange, des signes de nervosité ou d'autres indicateurs qui peuvent laisser penser qu'elle pourrait tenter de tromper quelqu'un. Le MJ fait un unique test de  Perception  secret à votre place et compare le résultat au DD de Duperie de la créature, au DD d'un sort qui affecte l'état mental de la créature ou à un autre DD qu'il juge approprié à la situation. Vous ne pouvez généralement pas refaire de tentative pour Deviner les intentions de cette même créature si la situation n'évolue pas significativement.</p>\n<p>\"Succès critique\" Vous devinez les véritables intentions de la créature et avez une bonne idée de toute magie mentale qui l'affecte.</p>\n<p>\"Succès\" Vous êtes capable de dire si la créature se comporte normalement ou non, mais vous ne connaissez pas ses véritables intentions ni le type de magie qui pourrait l'affecter.</p>\n<p>\"Échec\" Vous détectez seulement ce qu'une créature trompeuse cherche à vous faire croire. Si la créature ne cherche pas à vous tromper, vous êtes convaincu qu'elle se comporte normalement.</p>\n<p>\"Échec critique\" Votre impression concernant les intentions de la créature est erronée.</p>",
        "element_type": null,
        "href": "/actions/1xRFPTFtWtGJ9ELw",
        "id": "1xRFPTFtWtGJ9ELw",
        "price": null,
        "required": [],
        "text": "Deviner les intentions",
        "traits": [
            "Concentration",
            "Secret"
        ]
    ...
    "4D2KBtexWXa6oUMR": {
        ...
        "bulk": null,
        "category": "condition",
        "description": "<p>Votre santé et votre vitalité ont été épuisées lorsque vous avez perdu du sang, votre force vitale ou une autre essence. L'état Drainé est toujours accompagné d'une valeur. Vous subissez une pénalité de statut égal à la valeur de votre état Drainé et qui s'applique à tous les jets et DD basés sur la Constitution, tels que les jets de Vigueur. Vous perdez également un nombre de Points de vie égal à votre niveau (avec un minimum de 1) multiplié par la valeur de votre état Drainé et votre maximum de Points de vie est réduit de ce montant. Par exemple, si vous devenez Drainé 3 et que vous êtes un personnage de niveau 3, vous perdez 9 Points de vie et réduisez votre maximum de Points de vie de 9. Perdre ces Points de vie n'est pas considéré comme subir des dégâts.</p>\n<p>À chaque fois que vous vous reposez une nuit complète, la valeur de votre état Drainé diminue de 1. Cela accroît votre maximum de Points de vie, mais vous ne récupérez pas immédiatement les Points de vie que vous avez perdus.</p>",
        "element_type": null,
        "href": "/conditions/4D2KBtexWXa6oUMR",
        "id": "4D2KBtexWXa6oUMR",
        "price": null,
        "required": [],
        "text": "Drainée 1",
    ...
    "Dt6B1slsBy8ipJu9": {
        ...
        "bulk": null,
        "category": "action",
        "description": "<p>\"Conditions\" Vous disposez d'au moins une main libre. La cible ne peut pas être de plus d'une catégorie de taille supérieure à la vôtre.</p>\n<p>Vous essayez de faire tomber un objet de la prise d'une créature. Effectuez un test d' Athlétisme  contre le DD de Réflexes de l'adversaire.</p>\n<p>\"Succès critique\" Vous faites tomber l'objet de la main de la cible. Il tombe au sol dans l'espace de la cible.</p>\n<p>\"Succès\" Vous affaiblissez la prise de votre adversaire sur l'objet. Les tentatives ultérieures pour Désarmer la cible de cet objet bénéficient d'un bonus de circonstances de +2 et la cible subit une pénalité de circonstances de -2 aux attaques effectuées avec l'objet ou à d'autres tests nécessitant une prise ferme sur l'objet. La créature peut mettre un terme à cet effet en Interagissant pour modifier sa prise sur l'objet. À défaut, cela dure tant que la créature tient l'objet.</p>\n<p><div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'PuDS0DEq0CnaSIFV'})\">Effet : Désarmer (Succès)</div></p>\n<p>\"Échec critique\" Vous perdez l'équilibre et êtes  <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'AJh5ex99aV6VTggg'})\">Pris au dépourvu</div>  jusqu'au début de votre prochain tour.</p>",
        "element_type": null,
        "href": "/actions/Dt6B1slsBy8ipJu9",
        "id": "Dt6B1slsBy8ipJu9",
        "price": null,
        "required": [],
        "text": "Désarmer",
    ...
    "OlGO7dCLaghUXlQb": {
        ...
        "bulk": null,
        "category": "feat",
        "description": "<p>Vos études sur les applications de la magie sur le champ de bataille ont rendu vos sorts particulièrement efficaces pour perturber ou manipuler les formations ennemies afin de les placer dans des positions où elles sont plus vulnérables aux attaques magiques à grande échelle. Lorsque vous lancez un sort qui n'est pas un tour de magie infligeant des dégâts dans une zone, choisissez un nombre de cibles égal à votre modificateur d'Intelligence qui ont échoué leur jet de sauvegarde contre l'effet. Déplacez chacune de ces cibles jusqu'à 3 mètres de leur position originale après avoir subi les dégâts et tous les autres effets du sort. Vous ne pouvez pas déplacer une créature dans ou à travers des obstacles. Une créature de taille Moyenne ou inférieure compte pour une cible ; une créature Grande compte pour deux créatures Moyennes ; et une créature Très Grande compte pour quatre créatures Moyennes. Vous ne pouvez pas déplacer des créatures Gigantesques de cette manière.</p>\n<p>Vous obtenez également le don général  <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'BocFD2KV0qgUC76x'})\">Connaissance supplémentaire</div>  en Connaissance de la guerre. Si vous étiez déjà qualifié en Connaissance de la guerre, vous devenez qualifié en une connaissance de votre choix.</p>\n<p><div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'NkQidn5vlt6U1EFv'})\">Mage de guerre (Archétype de classe)</div></p>",
        "element_type": "DON 2",
        "href": "/feats/OlGO7dCLaghUXlQb",
        "id": "OlGO7dCLaghUXlQb",
        "price": null,
        "required": [
            "vous avez une capacité de classe d'incantation."
        ],
        "text": "Dévouement : Mage de guerre",
        "traits": [
            "Peu courant",
            "Archétype",
            "Class",
    ...
    "mz2x4HFrWT8usbEL": {
        ...
        "bulk": null,
        "category": "feat",
        "description": "<p>Votre lien avec votre péché imprègne l'ensemble de la magie que vous utilisez. Lorsque vous contemplez ou que vous vous adonnez à votre péché pour Refocaliser, vous pouvez aussi échanger un sort que vous avez préparé pour un des sorts de votre cursus ou de votre péché de même rang.</p>\n<p><div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': '09VwtSsYldMkVzU1'})\">Seigneur des runes (Archétype de classe)</div></p>",
        "element_type": "DON 2",
        "href": "/feats/mz2x4HFrWT8usbEL",
        "id": "mz2x4HFrWT8usbEL",
        "price": null,
        "required": [
            "Seigneur des runes"
        ],
        "text": "Dévouement : Seigneur des runes",
        "traits": [
            "Rare",
            "Archétype",
            "Class",
    ...
    "tx9pkrpmtqe4FnvS": {
        ...
        "bulk": null,
        "category": "feat",
        "description": "<p>Chaque jour, lorsque vous faites vos préparatifs quotidiens, vous pouvez vous harmoniser avec un élément de votre choix de votre philosophie élémentaire.</p>\n<p>Vous obtenez une résistance égale à la moitié de votre niveau (1 au minimum) contre les dégâts infligés par les effets ayant le trait élémentaire avec lequel vous êtes harmonisé.</p>\n<p>Cette harmonisation dure jusqu'à vos prochains préparatifs quotidiens.</p>\n<p><div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'O8qithYQCv3e7DUQ'})\">Effet : Dévouement : Élémentaliste</div></p>\n<p><div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'oMIA3aFKvpuV9f2H'})\">Élémentaliste (Archétype de classe)</div></p>",
        "element_type": "DON 2",
        "href": "/feats/tx9pkrpmtqe4FnvS",
        "id": "tx9pkrpmtqe4FnvS",
        "price": null,
        "required": [
            "Magie élémentaire"
        ],
        "text": "Dévouement d'élémentaliste",
        "traits": [
            "Archétype",
            "Class",
            "Dévouement"
    ...
    "qkwb5DD3zmKwvbk0": {
        ...
        "bulk": null,
        "category": "effect",
        "description": "<p>Accordé par  <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'aAbfKn8maGjJjk2W'})\">Armure mystique</div></p>\n<p>Vous obtenez un bonus d'objet de +1 à la CA et un modificateur de Dextérité maximum de +5.</p>\n<p>\"Intensifié (4e)\" Vous bénéficiez d'un bonus d'objet de +1 aux jets de sauvegarde.</p>",
        "element_type": null,
        "href": "/effects/qkwb5DD3zmKwvbk0",
        "id": "qkwb5DD3zmKwvbk0",
        "price": null,
        "required": [],
        "text": "Effet : Armure mystique",
        "traits": []
    },
    "GoSls6SKCFmSoDxT": {
        "action_cost": null,
        "bulk": null,
        "category": "effect",
        "description": "<p>Accordé par  <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': '0GF2j54roPFIDmXf'})\">Bon Mot</div></p>\n<p>Vous subissez une pénalité de statut aux tests de Perception et aux jets de Volonté.</p>",
        "element_type": null,
        "href": "/effects/GoSls6SKCFmSoDxT",
        "id": "GoSls6SKCFmSoDxT",
        "price": null,
        "required": [],
        "text": "Effet : Bon Mot",
    ...
    "mlvDokpnQBhvQrSk": {
        ...
        "bulk": null,
        "category": "effect",
        "description": "<p>Accordé par  <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'ZL97DcoJ8us6EwAF'})\">Boucliers de l'esprit</div></p>\n<p>\"Champion\" Vous Levez votre Bouclier.</p>\n<p>\"Allié\" Vous obtenez un bonus de statut de +1 à la CA tant que vous êtes dans l'aura de Champion.</p>",
        "element_type": null,
        "href": "/effects/mlvDokpnQBhvQrSk",
        "id": "mlvDokpnQBhvQrSk",
        "price": null,
        "required": [],
        "text": "Effet : Boucliers de l'esprit",
        "traits": []
    },
    "fpGDAz2v5PG0zUSl": {
        "action_cost": null,
        "bulk": null,
        "category": "effect",
        "description": "<p>Accordé par  <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'Gb7SeieEvd0pL2Eh'})\">Coup assuré</div> .</p>\n<p>La prochaine fois que vous effectuez un jet d'attaque avant la fin de votre tour, lancez l'attaque deux fois et utilisez le meilleur résultat. L'attaque ignore les pénalités de circonstances au jet d'attaque et vous n'avez pas besoin d'effectuer le test nu si la cible est Masquée ou Cachée.</p>",
        "element_type": null,
        "href": "/effects/fpGDAz2v5PG0zUSl",
        "id": "fpGDAz2v5PG0zUSl",
        "price": null,
        "required": [],
        "text": "Effet : Coup assuré",
        "traits": []
    },
    "61Hl31nyzt63vvX9": {
        "action_cost": null,
        "bulk": null,
        "category": "effect",
        "description": "<p>Accordé par  <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'rMOI8JFJ0nT2mrCF'})\">Déphasage de familier</div></p>\n<p>Votre familier obtient une résistance contre tous les dégâts et est immunisé contre les dégâts de précision.</p>",
        "element_type": null,
        "href": "/effects/61Hl31nyzt63vvX9",
        "id": "61Hl31nyzt63vvX9",
        "price": null,
        "required": [],
        "text": "Effet : Déphasage de familier",
        "traits": []
    },
    "7IUPl6dQUktXZh5t": {
        "action_cost": null,
        "bulk": null,
        "category": "effect",
        "description": "<p>Accordé par  <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'fPlFRu4dp09qJs3K'})\">Esprit de menace</div></p>\n<p>Vous obtenez la réaction  <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'hi56uHG1aAb84Zzu'})\">Se débattre avec la peur</div> .</p>",
        "element_type": null,
        "href": "/effects/7IUPl6dQUktXZh5t",
        "id": "7IUPl6dQUktXZh5t",
        "price": null,
        "required": [],
        "text": "Effet : Esprit de menace",
        "traits": []
    },
    "NQZ88IoKeMBsfjp7": {
        "action_cost": null,
        "bulk": null,
        "category": "effect",
        "description": "<p>Accordé par  <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'fAlzXtQAASaJx0mY'})\">Gain de vie</div> .</p>\n<p>Vous obtenez Guérison accélérée 2.\"Intensifié (+1)\" La guérison accélérée augmente de 2.</p>",
        "element_type": null,
        "href": "/effects/NQZ88IoKeMBsfjp7",
        "id": "NQZ88IoKeMBsfjp7",
        "price": null,
        "required": [],
        "text": "Effet : Gain de vie",
        "traits": []
    },
    "beReeFroAx24hj83": {
        "action_cost": null,
        "bulk": null,
        "category": "effect",
        "description": "<p>Accordé par  <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'IAjvwqgiDr3qGYxY'})\">Hymne de courage</div></p>\n<p>Vous obtenez un bonus de statut de +1 aux jets d'attaque, aux jets de dégâts et aux jets de sauvegarde contre les effets de terreur.</p>",
        "element_type": null,
        "href": "/effects/beReeFroAx24hj83",
        "id": "beReeFroAx24hj83",
        "price": null,
        "required": [],
        "text": "Effet : Hymne de courage",
        "traits": []
    },
    "lyLMiauxIVUM3oF1": {
        "action_cost": null,
        "bulk": null,
        "category": "effect",
        "description": "<p>Accordé par  <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'zNN9212H2FGfM7VS'})\">Imposition des mains</div></p>\n<p>Vous obtenez un bonus de statut de +2 à votre CA. Si vous êtes un mort-vivant, vous subissez une pénalité de -2 à votre CA.</p>",
        "element_type": null,
        "href": "/effects/lyLMiauxIVUM3oF1",
        "id": "lyLMiauxIVUM3oF1",
        "price": null,
        "required": [],
        "text": "Effet : Imposition des mains",
        "traits": []
    },
    "JqrTrvwV7pYStMXz": {
        "action_cost": null,
        "bulk": null,
        "category": "effect",
        "description": "<p>Accordé par  <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'fI20AVwOzJMHXRdo'})\">Lévitation</div> .</p>\n<p>Vous subissez une pénalité de circonstances de -2 aux jets d'attaque pendant que vous flottez dans les airs. Vous pouvez effectuer l'action Interagir pour vous stabiliser et annuler cette pénalité pendant le reste de votre tour.</p>",
        "element_type": null,
        "href": "/effects/JqrTrvwV7pYStMXz",
        "id": "JqrTrvwV7pYStMXz",
        "price": null,
        "required": [],
        "text": "Effet : Lévitation",
        "traits": []
    },
    "fILVhS5NuCtGXfri": {
        "action_cost": null,
        "bulk": null,
        "category": "effect",
        "description": "<p>Accordé par  <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'dKTb959aCQIzSIXj'})\">Lignage : Béni du ver</div></p>\n<p>La puissance draconique transparaît dans votre voix. Vous obtenez un bonus de statut de +1 aux tests d'intimidation pendant 1 round.</p>",
        "element_type": null,
        "href": "/effects/fILVhS5NuCtGXfri",
        "id": "fILVhS5NuCtGXfri",
        "price": null,
        "required": [],
        "text": "Effet : Magie du sang Béni du ver (bonus de statut - Soi)",
        "traits": []
    },
    "UQ7vZgmfK0VSFS8A": {
        "action_cost": null,
        "bulk": null,
        "category": "effect",
        "description": "<p>Accordé par  <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': '3qqvnC2U8W26yae7'})\">Lignage : Aberrant</div></p>\n<p>Soit une cible subit une pénalité de statut de -1 aux jets de Volonté pendant 1 round, soit vous obtenez un bonus de statut de +2 aux jets de Volonté pendant 1 round.</p>",
        "element_type": null,
        "href": "/effects/UQ7vZgmfK0VSFS8A",
        "id": "UQ7vZgmfK0VSFS8A",
        "price": null,
        "required": [],
        "text": "Effet : Magie du sang aberrant",
        "traits": []
    },
    "s1tulrmW6teTFjVd": {
        "action_cost": null,
        "bulk": null,
        "category": "effect",
        "description": "<p>Accordé par  <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'vhW3glAaEfq2DKrw'})\">Lignage : Angélique</div></p>\n<p>Une aura angélique vous protège ou protège une cible en conférant un bonus de statut de +1 aux jets de sauvegarde pendant 1 round.</p>",
        "element_type": null,
        "href": "/effects/s1tulrmW6teTFjVd",
        "id": "s1tulrmW6teTFjVd",
        "price": null,
        "required": [],
        "text": "Effet : Magie du sang angélique",
        "traits": []
    },
    "n1vhmOd7aNiuR3nk": {
        "action_cost": null,
        "bulk": null,
        "category": "effect",
        "description": "<p>Accordé par  <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'o39zQMIdERWtmBSB'})\">Lignage : Diabolique</div></p>\n<p>Vous bénéficiez d'un bonus de statut de +2 aux tests de Duperie pendant 1 round.</p>",
        "element_type": null,
        "href": "/effects/n1vhmOd7aNiuR3nk",
        "id": "n1vhmOd7aNiuR3nk",
        "price": null,
        "required": [],
        "text": "Effet : Magie du sang diabolique (Soi)",
        "traits": []
    },
    "aKRo5TIhUtu0kyEr": {
        "action_cost": null,
        "bulk": null,
        "category": "effect",
        "description": "<p>Accordé par  <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'w5koctOVrEcpxTIq'})\">Lignage : Démoniaque</div></p>\n<p>Soit une cible subit une pénalité de statut de -1 à la CA pendant 1 round, soit vous bénéficiez d'un bonus de statut de +2 aux tests d'Intimidation pendant 1 round.</p>",
        "element_type": null,
        "href": "/effects/aKRo5TIhUtu0kyEr",
        "id": "aKRo5TIhUtu0kyEr",
        "price": null,
        "required": [],
        "text": "Effet : Magie du sang démoniaque",
        "traits": []
    },
    "rJpkKaPRGaH0pLse": {
        "action_cost": null,
        "bulk": null,
        "category": "effect",
        "description": "<p>Accordé par  <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'eW3cfCH7Wpx2vik2'})\">Lignage : Féerique</div></p>\n<p>Vous obtenez un bonus de statut de +2 aux tests de Représentation.</p>",
        "element_type": null,
        "href": "/effects/rJpkKaPRGaH0pLse",
        "id": "rJpkKaPRGaH0pLse",
        "price": null,
        "required": [],
        "text": "Effet : Magie du sang féerique",
        "traits": []
    },
    "9AUcoY48H5LrVZiF": {
        "action_cost": null,
        "bulk": null,
        "category": "effect",
        "description": "<p>Accordé par  <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'tYOMBiH3HbViNWwn'})\">Lignage : Génie</div></p>\n<p>Soit vous obtenez un bonus de statut de +1 aux tests de Duperie pendant 1 round, soit une cible subit une pénalité de statut de -1 à la Perception pendant 1 round.</p>",
        "element_type": null,
        "href": "/effects/9AUcoY48H5LrVZiF",
        "id": "9AUcoY48H5LrVZiF",
        "price": null,
        "required": [],
        "text": "Effet : Magie du sang génie",
        "traits": []
    },
    "vguxP8ukwVTWWWaA": {
        "action_cost": null,
        "bulk": null,
        "category": "effect",
        "description": "<p>Accordé par  <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'ZEtJJ5UOlV5oTWWp'})\">Lignage : Impérial</div></p>\n<p>Vous bénéficiez au choix d'un bonus de statut de +1 à la CA ou d'un bonus de statut de +1 aux jets de sauvegarde.</p>",
        "element_type": null,
        "href": "/effects/vguxP8ukwVTWWWaA",
        "id": "vguxP8ukwVTWWWaA",
        "price": null,
        "required": [],
        "text": "Effet : Magie du sang impérial",
        "traits": []
    },
    "SVGW8CLKwixFlnTv": {
        "action_cost": null,
        "bulk": null,
        "category": "effect",
        "description": "<p>Accordé par  <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': '5Wxjghw7lHuCxjZz'})\">Lignage : Nymphe</div></p>\n<p>Soit vous obtenez un bonus de statut de +1 aux tests de Diplomatie pendant 1 round, soit vous imposez une pénalité de statut de -1 aux jets de Volonté de la cible pendant 1 round.</p>",
        "element_type": null,
        "href": "/effects/SVGW8CLKwixFlnTv",
        "id": "SVGW8CLKwixFlnTv",
        "price": null,
        "required": [],
        "text": "Effet : Magie du sang nymphe (Soi)",
        "traits": []
    },
    "Nv70aqcQgCBpDYp8": {
        "action_cost": null,
        "bulk": null,
        "category": "effect",
        "description": "<p>Accordé par  <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'uoQOm41BVdSo6pAS'})\">Lignage : Ombre</div></p>\n<p>Vous obtenez soit un bonus de statut de +1 à la Discrétion soit une pénalité de statut de -1 à la Perception.</p>",
        "element_type": null,
        "href": "/effects/Nv70aqcQgCBpDYp8",
        "id": "Nv70aqcQgCBpDYp8",
        "price": null,
        "required": [],
        "text": "Effet : Magie du sang ombre",
        "traits": []
    },
    "ViBlOrd6hno3DiPP": {
        "action_cost": null,
        "bulk": null,
        "category": "effect",
        "description": "<p>Accordé par  <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'X8PSYw6WC2ePYSXd'})\">Malédiction titubante</div></p>\n<p>The target takes a -2 status penalty to Athletics and Acrobatics checks.</p>",
        "element_type": null,
        "href": "/effects/ViBlOrd6hno3DiPP",
        "id": "ViBlOrd6hno3DiPP",
        "price": null,
        "required": [],
        "text": "Effet : Malédiction titubante",
        "traits": []
    },
    "AmsVO5Q6078mEvNt": {
        "action_cost": null,
        "bulk": null,
        "category": "effect",
        "description": "<p>Accordée par  <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': '6ZIKB0151LUR19Rw'})\">Mauvais présage</div></p>\n<p>Lorsque vous tentez un jet d'attaque ou un test de compétence, vous devez lancer deux fois et utiliser le pire résultat, la première fois en cas d'échec ou pendant toute la durée si c'était un échec critique.</p>",
        "element_type": null,
        "href": "/effects/AmsVO5Q6078mEvNt",
        "id": "AmsVO5Q6078mEvNt",
        "price": null,
        "required": [],
        "text": "Effet : Mauvais présage",
        "traits": []
    },
    "vhSYlQiAQMLuXqoc": {
        "action_cost": null,
        "bulk": null,
        "category": "effect",
        "description": "<p>Accordé par  <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': '25WDi1cVUrW92sUj'})\">Partager les indices</div> .</p>\n<p>Vous obtenez un bonus de circonstances de +1 à votre test. Si l'origine possède Expertise de l'enquêteur, ce bonus passe à +2.</p>",
        "element_type": null,
        "href": "/effects/vhSYlQiAQMLuXqoc",
        "id": "vhSYlQiAQMLuXqoc",
        "price": null,
        "required": [],
        "text": "Effet : Partager les indices",
        "traits": []
    },
    "aDOL3OAEWf3ka9oT": {
        "action_cost": null,
        "bulk": null,
        "category": "effect",
        "description": "<p>Accordé par le sort  <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'dFejDNEmVj3CwYLL'})\">Protection du sang</div></p>\n<p>La cible obtient un bonus de statut de +1 à ses jets de sauvegarde et à la CA contre les créatures avec le trait choisi.</p>",
        "element_type": null,
        "href": "/effects/aDOL3OAEWf3ka9oT",
        "id": "aDOL3OAEWf3ka9oT",
        "price": null,
        "required": [],
        "text": "Effet : Protection du sang",
        "traits": []
    },
    "cSoL5aMy3PCzM4Yv": {
        "action_cost": null,
        "bulk": null,
        "category": "effect",
        "description": "<p>Accordé par  <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': '9gMQPCaFM27PEIh4'})\">Rendre la faveur</div> .</p>\n<p>Vous obtenez des points de vie temporaires.</p>",
        "element_type": null,
        "href": "/effects/cSoL5aMy3PCzM4Yv",
        "id": "cSoL5aMy3PCzM4Yv",
        "price": null,
        "required": [],
        "text": "Effet : Rendre la Faveur",
        "traits": []
    },
    "Ef63SlxSKlZmHosM": {
        "action_cost": null,
        "bulk": null,
        "category": "effect",
        "description": "<p>Accordé par  <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': '8YIA0jh64Ecz0TG6'})\">Profanation</div></p>\n<p>Chaque ennemi dans votre aura de champion subit une pénalité de statut de -1 à ses jets d'attaque contre vous.</p>",
        "element_type": null,
        "href": "/effects/Ef63SlxSKlZmHosM",
        "id": "Ef63SlxSKlZmHosM",
        "price": null,
        "required": [],
        "text": "Effet : Réaction exaltée (Profanation)",
        "traits": []
    },
    "y4y0nusC97R7ZDL5": {
        "action_cost": null,
        "bulk": null,
        "category": "effect",
        "description": "<p>Accordé par  <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'f9uqHnNBMU0774SF'})\">Elemental Betrayal</div></p>\n<p>Lorsque vous Lancez ce sort, choisissez air, bois, eau, feu, métal ou terre. La cible obtient une faiblesse 2 contre ce trait.</p>",
        "element_type": null,
        "href": "/effects/y4y0nusC97R7ZDL5",
        "id": "y4y0nusC97R7ZDL5",
        "price": null,
        "required": [],
        "text": "Effet : Trahison élémentaire",
        "traits": []
    },
    "hkLhZsH3T6jc9S1y": {
        "action_cost": null,
        "bulk": null,
        "category": "effect",
        "description": "<p>Accordé par  <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'NNoKWiWKqJkdD2ln'})\">Voile de rêves</div></p>\n<p>Vous subissez une pénalité de statut de -1 à la Perception, aux jets d'attaques et aux jets de Volonté. Cette pénalité passe à -2 pour les jets de Volonté contre les effets de sommeil.</p>",
        "element_type": null,
        "href": "/effects/hkLhZsH3T6jc9S1y",
        "id": "hkLhZsH3T6jc9S1y",
        "price": null,
        "required": [],
        "text": "Effet : Voile de rêves",
        "traits": []
    },
    "MuRBCiZn5IKeaoxi": {
        "action_cost": null,
        "bulk": null,
        "category": "effect",
        "description": "<p>Accordé par  <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'A2JfEKe6BZcTG1S8'})\">Vol</div></p>\n<p>Vous obtenez une Vitesse de vol égale à votre Vitesse ou à 6 mètres (prendre la plus élevée).</p>",
        "element_type": null,
        "href": "/effects/MuRBCiZn5IKeaoxi",
        "id": "MuRBCiZn5IKeaoxi",
        "price": null,
        "required": [],
        "text": "Effet : Vol",
    ...
    "pprgrYQ1QnIDGZiy": {
        ...
        "bulk": null,
        "category": "action",
        "description": "<p>\"Conditions\" Vos deux mains sont libres.</p>\n<p>Vous tentez un test d' Athlétisme  pour monter de 1,50 mètre vers le haut, le bas ou pour franchir une déclivité. Vous êtes  <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'AJh5ex99aV6VTggg'})\">Pris au dépourvu</div>  lorsque vous Escaladez, sauf si vous possédez une Vitesse d'escalade. Le MJ détermine le DD en fonction de la nature de la déclivité et des circonstances environnementales. Vous pourriez obtenir un succès critique automatique sur une déclivité facile à escalader. Si votre Vitesse est de 12 mètres ou supérieure, augmentez la distance que vous pouvez Escalader de 1,50 mètre pour chaque tranche de 6 mètres au-dessus d'une Vitesse de 6 mètres.</p>\n<p>\"Succès critique\" Vous vous déplacez le long de la déclivité, augmentant la distance maximale de 1,50 mètre.</p>\n<p>\"Succès\" Vous vous déplacez le long de la déclivité.</p>\n<p>\"Échec critique\" Vous chutez. Si vous avez commencé votre escalade sur un sol stable, vous chutez et tombez  <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'j91X7x0XSomq8d60'})\">À terre</div> .</p>\nEscalader : exemples de tâches\n\n\"Inexpérimenté\" échelle, pente abrupte, arbre aux branches basses\n\"Qualifié\" gréement, corde, arbre typique\n\"Expert\" mur avec de petites prises pour les pieds et les mains\n\"Maître\" plafond avec des prises pour les pieds et les mains, mur de roche\n\"Légendaire\" surface lisse",
        "element_type": null,
        "href": "/actions/pprgrYQ1QnIDGZiy",
        "id": "pprgrYQ1QnIDGZiy",
        "price": null,
        "required": [],
        "text": "Escaladez",
    ...
    "OX4fy22hQgUHDr0q": {
        ...
        "bulk": null,
        "category": "action",
        "description": "<p>Après au moins une minute de conversation pendant laquelle vous faites des propositions charismatiques, des flatteries et montrez votre bonne volonté, vous cherchez à faire bonne impression à quelqu'un pour qu'il vous soit temporairement agréable. À la fin de la conversation, faites un test de  Diplomatie  contre le DD de Volonté d'une cible. Vous pouvez à la place choisir jusqu'à cinq cibles si vous acceptez une pénalité de -2. Le MJ pourrait ajouter d'autres bonus ou pénalités en fonction de la situation. Toute impression que vous laissez ne dure que pendant l'interaction sociale actuelle à moins que le MJ n'en décide autrement. Voir Changez les attitudes ci-dessous pour un résumé des attitudes.</p>\n<p>\"Succès critique\" L'attitude de la cible envers vous s'améliore de deux catégories.</p>\n<p>\"Succès\" L'attitude de la cible envers vous s'améliore d'une catégorie.</p>\n<p>\"Échec critique\" L'attitude de la cible envers vous se détériore d'une catégorie.</p>\n<h2>Changer les attitudes</h2>\n<p>Votre influence sur les PNJ est mesurée par le biais des attitudes qui reflètent la manière dont ils perçoivent votre personnage. Il ne s'agit que d'un bref résumé de la disposition d'une créature. Le MJ fournira la nuance supplémentaire en fonction de l'histoire et des croyances des personnages avec lesquels vous interagissez et leurs attitudes peuvent changer en accord avec l'histoire. Les attitudes sont résumées ci-après.</p>\n<ul><li>\"Serviable\" désireux de vous venir en aide et de répondre favorablement à vos sollicitations.</li><li>\"Amicale\" est bien disposé envers vous mais ne se mettra pas forcément en quatre pour vous aider.</li><li>\"Indifférente\" ne se préoccupe pas de vous dans un sens ou dans l'autre. (La plupart des PNJ commencent en vous étant indifférents).</li><li>\"Inamicale\" ne vous aide pas et ne souhaite pas vous aider.</li><li>\"Hostile\" travaille activement contre vous - et peut vous attaquer simplement parce qu'il ne vous aime pas.</li></ul>\n<p>Personne ne peut jamais changer l'attitude d'un personnage-joueur par le biais de ses compétences. Vous pouvez jouer les interactions avec les personnages des joueurs et même utiliser les résultats de Diplomatie si le joueur veut avoir une idée mécanique de la force de persuasion ou du charme d'un personnage, mais ce sont les joueurs qui décident en dernier ressort de la façon dont leurs personnages réagissent.</p>",
        "element_type": null,
        "href": "/actions/OX4fy22hQgUHDr0q",
        "id": "OX4fy22hQgUHDr0q",
        "price": null,
        "required": [],
        "text": "Faire bonne impression",
        "traits": [
            "Audible",
            "Concentration",
            "Exploration",
    ...
    "bcxIg7wi8ZAhvhOD": {
        ...
        "bulk": null,
        "category": "feat",
        "description": "<p>\"Ensorceleur, Magus\" Un animal se met à votre service et vous assiste lors de vos incantations.</p>\n<p>\"Magicien\" Vous faites un pacte avec une créature qui vous sert et vous assiste lors de vos incantations.</p>\n<p>\"Thaumaturge\" Que ce soit en suivant des rituels occultes, en mettant bout à bout des parcelles de théorie arcanique ou par une autre méthode, vous avez invoqué une créature qui vous sert désormais de compagnon constant dans vos recherches sur le surnaturel.</p>\n<p>Vous obtenez un familier.</p>",
        "element_type": "DON 1",
        "href": "/feats/bcxIg7wi8ZAhvhOD",
        "id": "bcxIg7wi8ZAhvhOD",
        "price": null,
        "required": [],
        "text": "Familier",
    ...
    "KZJJ0WxcRd4RZKJR": {
        ...
        "bulk": null,
        "category": "feat",
        "description": "<p>Votre familier devient un esprit élémentaire capable de prendre l'aspect des éléments. À part le fait de prendre la forme d'un élémentaire au lieu d'un animal, ce familier continue d'utiliser les mêmes règles que les autres familiers.</p>\n<p>Votre familier obtient un pouvoir de familier supplémentaire chaque jour, qui doit être l'un des pouvoirs de familier suivants. Lorsque votre familier possède un pouvoir de familier élémentaire, il est composé de la matière élémentaire associée et obtient le trait élémentaire correspondant. Vous ne pouvez pas choisir plus d'un pouvoir de familier élémentaire à la fois.</p>\n<ul><li>\"Air\" Si votre familier reste complètement immobile pendant 1 round, il devient  <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'zJxUflt9np0q4yML'})\">Invisible</div>  jusqu'à sa prochaine action. Tout mouvement, même s'il est déplacé ou porté par une autre créature, met un terme à cet effet.</li><li>\"Bois\" Si votre familier reste sous une lumière vire pendant 1 round, il obtient une guérison accélérée égale à la moitié de votre niveau. Une fois qu'il est sous la lumière vive, cet effet se termine.</li><li>\"Eau\" Votre familier peut franchir une ouverture de 5 centimètres de large sans avoir à  <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'kMcV8e5EZUxa6evt'})\">Se faufiler</div>  et peut se faufiler à travers un trou d'au moins 2,5 centimètres de large.</li><li>\"Feu\" Votre familier diffuse une lumière vive dans un rayon de 6 mètres (et une lumière faible dans les 6 mètres suivants) et émet de la chaleur. Les créatures qui restent dans une  émanation de 4,50 mètres  ne subissent pas les dégâts environnementaux de froid importants.</li><li>\"Métal\" Votre familier obtient une résistance contre les dégâts physiques des armes métalliques égale à la moitié de votre niveau.</li><li>\"Terre\" Votre familier obtient une résistance aux dégâts physiques (sauf ceux d'adamantium) égale à la moitié de votre niveau.</li></ul>",
        "element_type": "DON 4",
        "href": "/feats/KZJJ0WxcRd4RZKJR",
        "id": "KZJJ0WxcRd4RZKJR",
        "price": null,
        "required": [
            "Dévouement : Élémentaliste",
            ", Familier"
        ],
        "text": "Familier élémentaire",
        "traits": [
            "Archétype"
        ]
    },
    "AdPVz7rbaVSRxHFg": {
        ...
        "bulk": null,
        "category": "condition",
        "description": "<p>Vous êtes obligé de concentrer votre attention sur quelque chose, ce qui vous distrait de toute autre chose qui se déroule autour de vous. Vous subissez une pénalité de statut de -2 à la Perception et aux tests de compétence et vous ne pouvez pas utiliser d'actions ayant le trait concentration à moins qu'elles (ou leurs conséquences prévues) ne soient en rapport avec le sujet de votre fascination, à l'appréciation du MJ. Par exemple, vous pourriez être capable de  <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'BlAOM2X92SI6HMtJ'})\">Chercher</div>  ou de  <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': '1OagaWtBpVXExToo'})\">Vous souvenir</div>  à propos de ce sujet, mais vous ne pourriez probablement pas lancer un sort ciblant une créature différente. Cet état prend fin si une créature utilise des actions hostiles contre vous ou l'un quelconque de vos alliés.</p>",
        "element_type": null,
        "href": "/conditions/AdPVz7rbaVSRxHFg",
        "id": "AdPVz7rbaVSRxHFg",
        "price": null,
        "required": [],
        "text": "Fascinée",
    ...
    "eIcWbB5o3pP6OIMe": {
        ...
        "bulk": null,
        "category": "condition",
        "description": "<p>Vous êtes incapable de vous déplacer. Vous ne pouvez utiliser aucune action qui possède le trait déplacement. Si vous êtes immobilisé par quelque chose qui vous retient sur place et qu'une force extérieure tente de vous faire quitter votre espace, cette force doit réussir un test soit contre le DD de l'effet, soit la défense adaptée (généralement le DD de Vigueur) du monstre qui vous retient sur place.</p>",
        "element_type": null,
        "href": "/conditions/eIcWbB5o3pP6OIMe",
        "id": "eIcWbB5o3pP6OIMe",
        "price": null,
        "required": [],
        "text": "Immobilisée",
    ...
    "jftNJjBNxp2cleoi": {
        ...
        "bulk": null,
        "category": "action",
        "description": "<p>\"Fréquence\" Une fois toutes les 10 minutes</p>\n<p>Vous observez et évaluez votre environnement très rapidement. Vous  <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': '1OagaWtBpVXExToo'})\">Vous souvenez</div> ,  <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'BlAOM2X92SI6HMtJ'})\">Cherchez</div>  ou  <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': '1xRFPTFtWtGJ9ELw'})\">Deviner les intentions</div> .</p>",
        "element_type": null,
        "href": "/actions/jftNJjBNxp2cleoi",
        "id": "jftNJjBNxp2cleoi",
        "price": null,
        "required": [],
        "text": "Inspection expéditive",
        "traits": [
            "Enquêteur"
        ]
    },
    ...
    "i3OJZU2nk64Df3xm": {
        ...
        "bulk": null,
        "category": "condition",
        "description": "<p>Vos mouvements deviennent maladroits et incertains. L'état Maladroit est toujours accompagné d'une valeur. Vous subissez une pénalité de statut égale à la valeur de l'état qui s'applique à vos tests et à vos DD basés sur la Dextérité, y compris votre CA, vos jets de Réflexes, vos jets d'attaque à distance et vos tests de compétences basés sur Acrobaties, Discrétion et Vol.</p>",
        "element_type": null,
        "href": "/conditions/i3OJZU2nk64Df3xm",
        "id": "i3OJZU2nk64Df3xm",
        "price": null,
        "required": [],
        "text": "Maladroit 1",
    ...
    "ust1jJSCZQUhBZIz": {
        ...
        "bulk": null,
        "category": "action",
        "description": "<p>\"Conditions\" Vous bénéficiez d'un abri standard, êtes à proximité d'un élément de votre environnement derrière lequel vous abriter ou êtes  <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'j91X7x0XSomq8d60'})\">À terre</div> .</p>\n<p>Vous vous plaquez contre un mur ou vous jetez derrière un obstacle pour mieux vous mettre à l'abri. Si vous bénéficiez déjà d'un abri standard, vous obtenez à la place un abri important qui vous confère un bonus de circonstances de +4 à la CA, à vos jets de Réflexes contre les zones d'effet et à vos tests de Discrétion pour  Vous cacher ,  Être furtif  ou éviter de vous faire détecter de manière générale. Vous bénéficiez sinon des avantages liés à un abri standard (un bonus de circonstances de +2). Si vous êtes À terre, vous obtenez un abri supérieur contre les attaques à distance. Mise à l'abri dure jusqu'à ce que vous quittiez votre emplacement actuel, utilisiez une action d'attaque, deveniez  <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'fBnFDH2MTzgFijKf'})\">Inconscient</div>  ou mettiez fin à cet effet par une action gratuite.</p>",
        "element_type": null,
        "href": "/actions/ust1jJSCZQUhBZIz",
        "id": "ust1jJSCZQUhBZIz",
        "price": null,
        "required": [],
        "text": "Mettre à l'abri",
        "traits": []
    },
    "yZRUzMqrMmfLu0V1": {
        "action_cost": null,
        "bulk": null,
        "category": "condition",
        "description": "<p>Vous vous videz de votre sang ou vous trouvez aux portes de la mort. Lorsque vous avez cet état, vous êtes  <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'fBnFDH2MTzgFijKf'})\">Inconscient</div> . Mourant inclut toujours une valeur et, si celle-ci atteint jamais Mourant 4, vous mourez. Si vous êtes Mourant, vous devez tenter un test de récupération au début de votre tour à chaque round pour déterminer si votre état s'améliore ou se dégrade. La valeur de votre état Mourant augmente de 1 si vous subissez des dégâts alors que vous êtes Mourant ou de 2 si vous subissez des dégâts infligés par un coup critique ou un échec critique sur votre jet de sauvegarde.</p>\n<p>Si vous perdez l'état Mourant parce que vous avez réussi un test de récupération mais que vous êtes toujours à 0 Point de vie, vous restez Inconscient, mais vous pouvez vous réveiller comme indiqué pour cet état. Chaque fois que vous quittez l'état Mourant, vous obtenez l'état  <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'Yl48xTdMh3aeQYL2'})\">Blessé 1</div>  ou vous augmentez la valeur de votre état Blessé de 1 si vous subissez déjà cet état.</p>",
        "element_type": null,
        "href": "/conditions/yZRUzMqrMmfLu0V1",
        "id": "yZRUzMqrMmfLu0V1",
        "price": null,
        "required": [],
        "text": "Mourant",
    ...
    "c8TGiZ48ygoSPofx": {
        ...
        "bulk": null,
        "category": "action",
        "description": "<p>Vous tentez un test d' Athlétisme  pour vous déplacer d'une distance de 3 mètres dans l'eau. Le MJ détermine le DD en fonction des turbulences ou du danger de l'eau. Dans la plupart des eaux calmes, vous obtenez un succès critique automatique. Si votre Vitesse au sol est d'au moins 12 mètres, augmentez la distance maximale possible de déplacement de 1,50 mètre et de 1,50 mètre par tranche de 6 mètres au delà de 6 mètres.</p>\n<p>Si vous terminez votre tour dans l'eau et que vous n'avez pas obtenu un succès sur une action pour Nager au cours de ce tour, vous coulez de 3 mètres ou vous êtes emporté par le courant, au choix du MJ. Cela ne s'applique pas si votre dernière action lors de votre tour consistait à pénétrer dans l'eau.</p>\n<p>\"Succès critique\" Vous vous déplacez dans l'eau, en augmentant de 1,50 mètre la distance maximale.</p>\n<p>\"Succès\" Vous vous déplacez dans l'eau.</p>\n<p>\"Échec critique\" Vous ne progressez pas. Si vous reteniez votre souffle, vous perdez un round d'air.</p>\nNager : exemples de tâches\n\n\"Inexpérimenté\" lac ou autre étendue d'eau immobile\n\"Qualifié\" eau vive, telle que celle d'une rivière\n\"Expert\" rivière au débit rapide\n\"Maître\" mer démontée\n\"Légendaire\" maelström, chute d'eau",
        "element_type": null,
        "href": "/actions/c8TGiZ48ygoSPofx",
        "id": "c8TGiZ48ygoSPofx",
        "price": null,
        "required": [],
        "text": "Nagez",
    ...
    "1wQY3JYyhMYeeV2G": {
        ...
        "bulk": null,
        "category": "condition",
        "description": "<p>Tout ce qui est dans votre champ de vision est observé par vos soins. Si une créature prend des mesures pour éviter la détection, comme en utilisant sa Discrétion pour  <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'XMcnh4cSI32tljXa'})\">Se cacher</div> , elle peut devenir  <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'iU0fEDdBp3rXpTMC'})\">Cachée</div>  ou  <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'VRSef5y1LmL2Hkjf'})\">Non détectée</div>  au lieu d'observée. Si vous disposez d'un autre sens précis en plus de la vue, vous pourriez être capable d'observer une créature ou un objet en utilisant ce sens à la place. Vous ne pouvez observer une créature qu'à l'aide d'un sens précis. Lorsque vous  <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'BlAOM2X92SI6HMtJ'})\">Cherchez</div>  une créature en utilisant seulement des sens imprécis, elle reste Cachée plutôt qu'observée.</p>",
        "element_type": null,
        "href": "/conditions/1wQY3JYyhMYeeV2G",
        "id": "1wQY3JYyhMYeeV2G",
        "price": null,
        "required": [],
        "text": "Observé",
    ...
    "SjmKHgI7a5Z9JzBx": {
        ...
        "bulk": null,
        "category": "action",
        "description": "<p>En utilisant votre corps, un levier ou un autre outil, vous tentez de forcer l'ouverture d'une porte, d'une fenêtre, d'un contenant ou d'une grille épaisse. Avec un résultat suffisamment élevé, vous pouvez même traverser des murs. Sans pied-de-biche, vous subissez une pénalité d'objet de -2 au test d' Athlétisme  si vous tentez d'Ouvrir de force quelque chose.</p>\n<p>\"Succès critique\" Vous ouvrez la porte, la fenêtre, le contenant ou la grille et pouvez éviter de l'endommager si vous le souhaitez.</p>\n<p>\"Succès\" Vous brisez la porte, la fenêtre, le contenant ou ouvrez la porte et il obtient l'état  <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': '6dNUvdb1dhToNDj3'})\">Brisé</div> . Si c'est particulièrement robuste, le MJ pourrait lui faire subir des dégâts mais sans qu'il soit Brisé.</p>\n<p>\"Échec critique\" Votre tentative bloque la porte, la fenêtre, le contenant ou l'ouverture de la grille, imposant une pénalité de circonstances de -2 sur les futures tentatives pour l'Ouvrir de force.</p>\nOuvrir de force : exemples de tâches\n\n\"Inexpérimenté\" tissu, verre fin\n\"Qualifié\" glace, verre épais\n\"Expert\" porte en bois peu épais, herse en bois\n\"Maître\" porte en bois épais, herse en fer, barreau métallique\n\"Légendaire\" porte en pierre ou en fer",
        "element_type": null,
        "href": "/actions/SjmKHgI7a5Z9JzBx",
        "id": "SjmKHgI7a5Z9JzBx",
        "price": null,
        "required": [],
        "text": "Ouvrir de force",
        "traits": [
            "Attaque"
        ]
    },
    ...
    "QHFMeJGzFWj2QczA": {
        ...
        "bulk": null,
        "category": "action",
        "description": "<p>\"Coût\" 1 fiole polyvalente</p>\n<p>\"Conditions\" Vous connaissez la formule de l'objet alchimique que vous créez, vous tenez ou portez du Matériel d'alchimiste et vous disposez d'une main libre.</p>\n<p>Vous concoctez rapidement une préparation à la durée de validité très courte. Vous créez un unique élixir ou outil alchimique de votre niveau ou moins sans avoir à dépenser le coût monétaire habituel en réactifs alchimiques et sans avoir à effectuer un test d'Artisanat. L'objet possède le trait imprégné mais il reste efficace seulement jusqu'à la fin de votre tour actuel.</p>",
        "element_type": null,
        "href": "/actions/QHFMeJGzFWj2QczA",
        "id": "QHFMeJGzFWj2QczA",
        "price": null,
        "required": [],
        "text": "Préparation rapide",
        "traits": [
            "Enquêteur",
            "Manipulation"
        ]
    ...
    "xYTAsEpcJE1Ccni3": {
        ...
        "bulk": null,
        "category": "condition",
        "description": "<p>Vous disposez de moins d'actions. L'état Ralenti inclut une valeur. Lorsque vous regagnez des actions, réduisez la quantité d'actions que vous obtenez de la valeur de votre état Ralenti. Comme vous obtenez des actions au début de votre tour, vous ne perdez pas immédiatement des actions si vous obtenez cet état au cours de votre tour.</p>",
        "element_type": null,
        "href": "/conditions/xYTAsEpcJE1Ccni3",
        "id": "xYTAsEpcJE1Ccni3",
        "price": null,
        "required": [],
        "text": "Ralenti 1",
    ...
    "Tj055UcNm6UEgtCg": {
        ...
        "bulk": null,
        "category": "action",
        "description": "<p>\"Conditions\" Vous êtes à terre et votre Vitesse est d'au moins 3 mètres.</p>\n<p>Vous vous déplacez de 1,50 mètre en rampant, en continuant à rester  <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'j91X7x0XSomq8d60'})\">À terre</div> .</p>",
        "element_type": null,
        "href": "/actions/Tj055UcNm6UEgtCg",
        "id": "Tj055UcNm6UEgtCg",
        "price": null,
        "required": [],
        "text": "Ramper",
    ...
    "SkZAQRkLLkmBQNB9": {
        ...
        "bulk": null,
        "category": "action",
        "description": "<p>Vous tentez de vous tirer d'une situation dans laquelle vous êtes  <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'kWc1fhmv9LBiTuei'})\">Agrippé</div> ,  <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'eIcWbB5o3pP6OIMe'})\">Immobilisé</div>  ou  <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'VcDeM8A5oI6VqhbM'})\">Entravé</div> . Choisissez une créature, un objet, un effet de sort, un danger ou un autre obstacle qui vous impose l'un de ces états. Vous faites un test contre le DD de cet effet en utilisant votre  modificateur d'attaque à mains nues . Il s'agit généralement du DD d'Athlétisme de la créature qui vous agrippe, du DD de Vol de la créature qui vous a attaché, du DD des sorts qui vous affectent ou du DD pour S'échapper indiqué dans le profil d'un objet, d'un danger ou d'un autre obstacle. Au lieu d'utiliser votre modificateur d'attaque, vous pouvez faire un test d' Acrobaties  ou d' Athlétisme  (mais cette action possède toujours le trait attaque).</p>\n<p>\"Succès critique\" Vous vous libérez et perdez l'état Agrippé, Immobilisé ou Entravé que la cible désignée vous imposait. Vous pouvez alors Marcher rapidement sur une distance de 1,50 mètre.</p>\n<p>\"Succès\" Vous vous libérez et perdez l'état Agrippé, Immobilisé ou Entravé que la cible désignée vous imposait.</p>\n<p>\"Échec critique\" Vous ne réussissez pas à vous libérer et vous ne pouvez pas tenter de Vous échapper avant votre prochain tour.</p>",
        "element_type": null,
        "href": "/actions/SkZAQRkLLkmBQNB9",
        "id": "SkZAQRkLLkmBQNB9",
        "price": null,
        "required": [],
        "text": "S'Échapper",
    ...
    "hi56uHG1aAb84Zzu": {
        ...
        "bulk": null,
        "category": "action",
        "description": "<p>\"Déclencheur\" Une créature que vous pouvez voir utilise un effet mental contre vous</p>\n<p>\"Effet\" La créature déclencheuse doit tenter un jet de Volonté avec les effets suivants.</p>\n<p>\"Succès\" La créature n'est pas affectée.</p>\n<p>\"Échec\" La créature est  <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'TBSHQspnbcqxsmjL'})\">Effrayée 2</div>  et vous obtenez un bonus de statut de +2 à votre jet de sauvegarde ou à toute autre défense contre l'effet mental déclencheur.</p>\n<p>\"Échec critique\" La créature est  <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'TBSHQspnbcqxsmjL'})\">Effrayée 2</div>  et vous n'êtes pas affecté par l'effet mental déclencheur.</p>",
        "element_type": null,
        "href": "/actions/hi56uHG1aAb84Zzu",
        "id": "hi56uHG1aAb84Zzu",
        "price": null,
        "required": [],
        "text": "Se débattre avec la peur",
        "traits": [
            "Concentration",
            "Émotion",
            "Terreur",
    ...
    "sn2hIy1iIJX9Vpgj": {
        ...
        "bulk": null,
        "category": "action",
        "description": "<p>\"Conditions\" Une créature est non détectée par un ou plusieurs de vos alliés, mais pas par vous.</p>\n<p>Vous désignez une créature que vous pouvez voir à un ou plusieurs de vos alliés, en la montrant du doigt et en indiquant verbalement à quelle distance elle se trouve. La créature se trouve alors  <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'iU0fEDdBp3rXpTMC'})\">Cachée</div>  par rapport à vos alliés plutôt que  <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'VRSef5y1LmL2Hkjf'})\">Non détectée</div> . Cela ne fonctionne que si vos alliés peuvent vous voir et qu'ils se trouvent à un endroit d'où ils pourraient potentiellement détecter la cible. Si vos alliés ne peuvent pas vous entendre ou vous comprendre, ils doivent alors réussir un test de Perception contre le DD de Discrétion de la créature. En cas d'échec, ils vous comprennent mal et croient que la cible se trouve à un autre endroit que celui que vous désignez.</p>",
        "element_type": null,
        "href": "/actions/sn2hIy1iIJX9Vpgj",
        "id": "sn2hIy1iIJX9Vpgj",
        "price": null,
        "required": [],
        "text": "Signaler",
    ...
    "5hUj7glY8YnO5sBI": {
        ...
        "bulk": null,
        "category": "feat",
        "description": "<p>Vous accédez aux enseignements avancés de votre institution arcanique et apprenez un nouveau sort puissant. Vous obtenez le sort d'école avancé de votre école arcanique.</p>",
        "element_type": "DON 8",
        "href": "/feats/5hUj7glY8YnO5sBI",
        "id": "5hUj7glY8YnO5sBI",
        "price": null,
        "required": [
            "École arcanique"
        ],
        "text": "Sort d'école avancé",
        "traits": [
            "Magicien"
        ]
    },
    "SNgOGKUHAxgFJgxW": {
        ...
        "bulk": null,
        "category": "feat",
        "description": "<p>Votre sort désoriente vos cibles en produisant un fracas métallique. Si la prochaine action que vous utilisez au cours de ce tour consiste à Lancer un sort qui n'est pas un tour de magie et qui inflige des dégâts dans une zone (comme une explosion, une ligne ou un cône), le sort inflige  1d8 dégâts  supplémentaires et toutes les créatures qui obtiennent un échec sur leur jet de sauvegarde sont  <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': '9PR9y0bi4JPKnHPR'})\">Sourdes</div>  pendant 1 round. Les cibles qui obtiennent un échec critique à leur jet de sauvegarde contre ce sort sont Sourdes pendant 1 minute. Le sort obtient le trait son.</p>",
        "element_type": "DON 10",
        "href": "/feats/SNgOGKUHAxgFJgxW",
        "id": "SNgOGKUHAxgFJgxW",
        "price": null,
        "required": [
            "Dévouement : Élémentaliste",
            ", votre philosophie élémentaire est le métal"
        ],
        "text": "Sort réverbéré",
        "traits": [
            "Archétype",
    ...
    "9PR9y0bi4JPKnHPR": {
        ...
        "bulk": null,
        "category": "condition",
        "description": "<p>Vous ne pouvez pas entendre. Vous obtenez automatiquement un échec critique aux tests de Perception qui nécessitent que vous puissiez les entendre. Vous subissez une pénalité de statut de -2 à vos tests de Perception pour déterminer l'initiative et aux tests en rapport avec le son mais comptent aussi sur d'autres sens. Si vous accomplissez une action qui possède le trait audible, vous devez réussir un  Test nu  ou perdre l'action. Vous faites ce test après avoir dépensé l'action mais avant que tout effet ne soit appliqué. Vous êtes immunisé contre les effets audibles tant que vous êtes Sourd.</p>",
        "element_type": null,
        "href": "/conditions/9PR9y0bi4JPKnHPR",
        "id": "9PR9y0bi4JPKnHPR",
        "price": null,
        "required": [],
        "text": "Sourde",
    ...
    "e1XGnhKNSQIm5IXg": {
        ...
        "bulk": null,
        "category": "condition",
        "description": "<p>Vos pensées et vos instincts sont embrouillés. L'état Stupéfié est toujours accompagné d'une valeur. Vous subissez une pénalité de statut égal à cette valeur sur les tests et les DD basés sur l'Intelligence, la Sagesse et le Charisme, y compris vos jets de Volonté, vos modificateurs d'attaque de sort, vos DD de sorts et vos tests de compétences qui utilisent ces modificateurs d'attribut. À chaque fois que vous tentez de  <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'aBQ8ajvEBByv45yz'})\">Lancer un sort</div>  alors que vous êtes Stupéfié, ce sort est interrompu à moins de réussir un  Test nu  dont le DD est égal à 5 + la valeur de votre état Stupéfié.</p>",
        "element_type": null,
        "href": "/conditions/e1XGnhKNSQIm5IXg",
        "id": "e1XGnhKNSQIm5IXg",
        "price": null,
        "required": [],
        "text": "Stupéfiée 1",
    ...
    "cS9nfDRGD83bNU1p": {
        ...
        "bulk": null,
        "category": "action",
        "description": "<p>\"Conditions\" Vous avez une Vitesse de vol.</p>\n<p>Vous vous déplacez dans les airs d'une distance maximale égale à votre Vitesse de vol. Vous appliquez les règles du déplacement sur un terrain difficile pour vous déplacer vers le haut (verticalement ou en diagonale). Vous pouvez vous diriger verticalement vers le bas de 3 mètres en dépensant 1,50 mètre de mouvement. Si vous Volez jusqu'au sol, vous ne subissez pas de dégâts de chute. Vous pouvez utiliser une action pour Voler sur une distance de 0 mètre afin de faire du vol stationnaire. Si vous êtes dans les airs à la fin de votre tour et que vous n'avez pas utilisé d'action pour Voler lors de ce tour, vous chutez.</p>",
        "element_type": null,
        "href": "/actions/cS9nfDRGD83bNU1p",
        "id": "cS9nfDRGD83bNU1p",
        "price": null,
        "required": [],
        "text": "Volez",
    ...
    "XMcnh4cSI32tljXa": {
        ...
        "bulk": null,
        "category": "action",
        "description": "<p>Vous vous blottissez derrière un abri standard ou important ou derrière un élément qui offre un camouflage pour être  <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'iU0fEDdBp3rXpTMC'})\">Caché</div>  plutôt qu' <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': '1wQY3JYyhMYeeV2G'})\">Observé</div> . Le MJ effectue votre test de  Discrétion  en secret et compare le résultat au DD de Perception de chacune des créatures qui vous observe mais vis-à-vis desquelles vous bénéficiez d'un abri standard ou important ou êtes  <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'DmAIPqOBomZ7H95W'})\">Masqué</div> . Vous obtenez un bonus de circonstances de +2 si vous disposez d'un abri standard (ou de +4 pour un abri important).</p>\n<p>\"Succès\" Si la créature pouvait vous voir, vous êtes à présent  <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'iU0fEDdBp3rXpTMC'})\">Caché</div>  d'elle et non plus Observé. Si vous étiez Caché ou  <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'VRSef5y1LmL2Hkjf'})\">Non détecté</div>  par la créature, vous conservez cet état.</p>\n<p>Si vous avez réussi à vous cacher d'une créature mais que vous ne bénéficiez plus d'un abri standard ou important ou n'êtes pas masqué vis-à-vis d'elle, vous redevenez Observé. Vous cessez d'être Caché si vous faites quoi que ce soit d'autre que Vous cacher,  <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'VMozDqMMuK5kpoX4'})\">Être furtif</div>  ou Faire un pas. Si vous tentez de Frapper une créature, celle-ci reste  <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'AJh5ex99aV6VTggg'})\">Prise au dépourvu</div>  contre cette attaque puis vous devenez Observé. Si vous faites quoi que ce soit d'autre, vous devenez Observé juste avant que vous n'agissiez, à moins que le MJ n'en décide autrement. Le MJ pourrait vous autoriser à accomplir une action particulièrement discrète sans vous faire repérer, possiblement en vous faisant relancer un autre test de Discrétion.</p>\n<p>Si une créature utilise  <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'BlAOM2X92SI6HMtJ'})\">Chercher</div>  dans le but de vous observer, vous devez réussir à Vous cacher pour vous cacher d'elle à nouveau.</p>",
        "element_type": null,
        "href": "/actions/XMcnh4cSI32tljXa",
        "id": "XMcnh4cSI32tljXa",
        "price": null,
        "required": [],
        "text": "Vous cacher",
    ...
    "OdIUybJ3ddfL7wzj": {
        ...
        "bulk": null,
        "category": "action",
        "description": "<p>Vous étiez  <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'j91X7x0XSomq8d60'})\">À terre</div>  et vous Vous relevez.</p>",
        "element_type": null,
        "href": "/actions/OdIUybJ3ddfL7wzj",
        "id": "OdIUybJ3ddfL7wzj",
        "price": null,
        "required": [],
        "text": "Vous relever",
    ...
    "ktjFOp3U0wQD9t0Z": {
        ...
        "bulk": "L",
        "category": "item",
        "description": "<p>\"Activation\" A (manipulation)</p>\n<p>L'antidote vous protège contre les toxines. Lorsque vous le buvez, vous obtenez un bonus d'objet de +2 aux jets de Vigueur contre les poisons pendant 6 heures.</p>\n<p><div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'TjBxxlTvb6tJP1jS'})\">Effet : Antidote</div></p>",
        "element_type": "OBJET 1",
        "href": "/equipment/ktjFOp3U0wQD9t0Z",
        "id": "ktjFOp3U0wQD9t0Z",
        "price": "3 po",
        "required": [],
        "text": "antidote inférieur",
        "traits": [
            "Alchimique",
            "Consommable",
            "Élixir",
    ...
    "UqinuuCWePTYGhVO": {
        ...
        "bulk": "L",
        "category": "item",
        "description": "<p>\"Activation\" A (manipulation)</p>\n<p>L'antimaladie renforce les défenses du corps contre les maladies. Lorsque vous le buvez, vous obtenez un bonus d'objet de +2 aux jets de Vigueur contre les maladies pendant 24 heures. Cela s'applique aussi à votre jet de sauvegarde quotidien contre la progression d'une maladie.</p>\n<p><div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'mVgLCbZgafIylRzh'})\">Effet : Antimaladie</div></p>",
        "element_type": "OBJET 1",
        "href": "/equipment/UqinuuCWePTYGhVO",
        "id": "UqinuuCWePTYGhVO",
        "price": "3 po",
        "required": [],
        "text": "antimaladie inférieur",
        "traits": [
            "Alchimique",
            "Consommable",
            "Élixir",
    ...
    "TkIyaNPgTZFBCCuh": {
        ...
        "bulk": null,
        "category": "condition",
        "description": "<p>Vos yeux ont été soumis à un excès de stimuli ou votre vision est en train de se brouiller. Si la vue est votre unique sens précis, toutes les créatures et les objets vous sont  <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'DmAIPqOBomZ7H95W'})\">Masqués</div> .</p>",
        "element_type": null,
        "href": "/conditions/TkIyaNPgTZFBCCuh",
        "id": "TkIyaNPgTZFBCCuh",
        "price": null,
        "required": [],
        "text": "Éblouie",
    ...
    "dfCMdR4wnpbYNTix": {
        ...
        "bulk": null,
        "category": "condition",
        "description": "<p>Vous êtes inerte. Vous ne pouvez pas agir. L'état Étourdi s'accompagne habituellement d'une valeur qui indique la quantité d'actions que vous perdez, possiblement sur plusieurs tours, du fait d'être Étourdi. À chaque fois que vous regagnez des actions, vous déduisez la quantité d'actions regagnées de la valeur de votre état Étourdi, puis vous déduisez la valeur de votre état Étourdi par le nombre d'actions que vous avez perdues. Par exemple, si vous étiez  <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'dfCMdR4wnpbYNTix'})\">Étourdi 4</div> , vous devriez perdre la totalité de vos 3 actions au début de votre tour, réduisant la valeur de votre état Étourdi à 1. Lors de votre prochain tour, vous perdrez 1 action supplémentaire et serez capable d'utiliser vos 2 actions restantes normalement. L'état Étourdi peut aussi être assorti d'une durée à la place d'une valeur, comme « Étourdi pendant 1 minute », vous faisant perdre la totalité de vos actions pendant la durée indiquée.</p>\n<p>L'état Étourdi l'emporte sur l'état  <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'xYTAsEpcJE1Ccni3'})\">Ralenti</div> . Si la durée de votre état Étourdi se termine lorsque vous êtes Ralenti, les actions perdues du fait de l'état Étourdi sont prises en compte dans le décompte des actions perdues du fait de l'état Ralenti. Ainsi, si vous êtes  <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'dfCMdR4wnpbYNTix'})\">Étourdi 1</div>  et Ralenti 2 au début de votre tour, vous perdez 1 action à cause de l'état Étourdi puis perdez 1 action supplémentaire car vous êtes Ralenti, de sorte que vous aurez 1 action restante à utiliser durant ce tour.</p>",
        "element_type": null,
        "href": "/conditions/dfCMdR4wnpbYNTix",
        "id": "dfCMdR4wnpbYNTix",
        "price": null,
        "required": [],
        "text": "Étourdie 1",
    ...
    "VMozDqMMuK5kpoX4": {
        ...
        "bulk": null,
        "category": "action",
        "description": "<p>Vous tentez de vous déplacer vers un autre endroit tout en devenant ou en restant non détecté. Marcher rapidement sur une distance maximale égale à la moitié de votre Vitesse (vous pouvez Être furtif en Creusant, en Escaladant, en Volant ou en Nageant au lieu de Marcher rapidement si vous disposez du type de déplacement correspondant et vous devez vous déplacer à la moitié de cette Vitesse).</p>\n<p>À la fin de votre déplacement, le MJ effectue votre test de  Discrétion  en secret et compare le résultat au DD de Perception de chaque créature vis-à-vis desquelles vous étiez  <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'iU0fEDdBp3rXpTMC'})\">Caché</div>  ou  <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'VRSef5y1LmL2Hkjf'})\">Non détecté</div>  au début de votre déplacement. Si vous bénéficiez d'un abri standard ou important vis-à-vis d'une créature pendant que vous Marchez rapidement, vous obtenez un bonus de circonstances à votre test de Discrétion de +2 grâce à l'abri (ou de +4 grâce à un abri important). Comme vous vous déplacez, l'augmentation du bonus de  <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'ust1jJSCZQUhBZIz'})\">Mise à l'abri</div>  ne s'applique pas. Vous ne faites pas de test contre une créature si, à la fin de votre déplacement, vous n'êtes plus  <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'DmAIPqOBomZ7H95W'})\">Masqué</div>  ou si vous ne bénéficiez plus d'un abri standard ou important vis-à-vis d'elle. Vous devenez automatiquement  <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': '1wQY3JYyhMYeeV2G'})\">Observé</div>  par une telle créature.</p>\n<p>\"Succès\" Vous êtes Non détecté par la créature pendant votre déplacement et le restez à la fin de votre déplacement. Vous devenez Observé dès que vous faites quoi que ce soit d'autre que Vous cacher, Être furtif ou Faire un pas. Si vous Frappez une créature, celle-ci reste  <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'AJh5ex99aV6VTggg'})\">Prise au dépourvu</div>  contre cette attaque puis vous devenez Observé. Si vous faites quoi que ce soit d'autre, vous devenez Observé juste avant que vous n'agissiez, à moins que le MJ n'en décide autrement. Le MJ pourrait vous autoriser à accomplir une action particulièrement discrète sans vous faire repérer, possiblement en relançant un autre test de Discrétion. Si vous parlez ou produisez délibérément un bruit fort, vous devenez Caché au lieu de Non détecté. Si une créature utilise  <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'BlAOM2X92SI6HMtJ'})\">Chercher</div>  et qu'il en résulte que vous devenez Caché à son égard, vous devez Être furtif si vous voulez redevenir Non détecté à son égard.</p>\n<p>\"Échec\" Un bruit ou autre signe révèle votre position, bien que vous puissiez rester hors de vue. Vous êtes Caché de la créature pendant votre déplacement et le restez.</p>\n<p>\"Échec critique\" Vous êtes repéré ! Vous êtes Observé par la créature pendant votre déplacement et le restez. Si vous êtes Invisible et que vous étiez Caché de la créature, vous êtes Caché pendant votre déplacement et le restez.</p>",
        "element_type": null,
        "href": "/actions/VMozDqMMuK5kpoX4",
        "id": "VMozDqMMuK5kpoX4",
        "price": null,
        "required": [],
        "text": "Être furtif",
    ...
    "hDLbR56Id2OtU318": {
        ...
        "bulk": "L",
        "category": "item",
        "description": "<p>\"Activation\" A (manipulation)</p>\n<p>L'élixir de vie accélère le processus de guérison naturel du corps et son système immunitaire. En le buvant, vous récupérez  1d6 Points de vie  et obtenez un bonus d'objet de +1 aux jets de sauvegarde contre la maladie et le poison pendant 10 minutes.</p>\n<p><div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'lPRuIRbu0rHBkoKY'})\">Effet : Élixir de vie</div></p>",
        "element_type": "OBJET 1",
        "href": "/equipment/hDLbR56Id2OtU318",
        "id": "hDLbR56Id2OtU318",
        "price": "3 po",
        "required": [],
        "text": "élixir de vie mineur",
        "traits": [
            "Alchimique",
            "Consommable",
            "Élixir",
    ...
    "is3Oz9wt11lNq62K": {
        ...
        "bulk": null,
        "category": "feat",
        "description": "<p>Vous pouvez utiliser l'activité Artisanat pour créer des objets alchimiques. Quand vous choisissez ce don, vous ajoutez immédiatement les formules de quatre objets alchimiques courants de niveau 1 à votre recueil.</p>",
        "element_type": "DON 1",
    ...
    "qCEOZ6109Yo34tRx": {
        ...
        "bulk": "L",
        "category": "item",
        "description": "<p>Un recueil de formules contient les formules nécessaires pour fabriquer des objets autres que l'équipement courant. Les alchimistes en reçoivent généralement un gratuitement. Chaque recueil de formules peut contenir les formules d'un maximum de 100 objets différents. Les formules peuvent également apparaître sur des feuilles de parchemin, des tablettes et presque n'importe quel autre support. Vous n'avez pas besoin de les copier dans un livre spécifique tant que vous pouvez les garder sous la main pour vous y référer.</p>",
        "element_type": "OBJET 0",
    ...
    "yzNJgwzV9XqEhKc6": {
        ...
        "bulk": null,
        "category": "action",
        "description": "\"Conditions\" Vous maniez ou portez du  <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': '4ftXXUCBHcf4b0MH'})\">Matériel d'alchimiste</div>  et vous disposez d'une main libre.</p>\n<p>Vous pouvez soit utiliser une fiole polyvalente pour fabriquer un autre consommable alchimique au pied levé, soit créer une fiole polyvalente particulièrement éphémère. Tout effet créé par un objet fabriqué avec l'Alchimie rapide qui aurait une durée supérieure à 10 minutes dure 10 minutes à la place.</p>\n<ul><li>\"Créer un consommable\" Vous dépensez l'une de vos fioles polyvalentes pour créer un objet alchimique consommable de votre niveau ou inférieur qui se trouve dans votre livre de formules. Vous n'avez pas à dépenser le coût monétaire normal en matières premières alchimiques ni à tenter un test d'Artisanat. Cet objet possède le trait imprégné, mais il ne reste efficace que jusqu'au début de votre prochain tour. Comme d'habitude, vous n'avez besoin que d'une seule formule pour un objet pour créer n'importe quel niveau de cet objet.</li><li>\"Fiole rapide\" Vous créez une fiole polyvalente qui ne peut être utilisée que comme bombe ou pour l'option de fiole polyvalente de votre champ de recherche (elle ne peut pas être utilisée pour créer un consommable, par exemple). Cet objet possède le trait imprégné, mais il ne reste efficace que jusqu'à la fin de votre tour actuel.</li></ul>",
        "element_type": null,
    ...
    "sPtl05wwTpqFI0lL": {
        ...
        "bulk": null,
        "category": "feat",
        "description": "<p>Vous obtenez l'action  <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'yzNJgwzV9XqEhKc6'})\">Alchimie rapide</div>  pour faire les objets dont vous avez besoin à la volée.</p>",
        "element_type": null,
    ...
    "4ftXXUCBHcf4b0MH": {
        ...
        "bulk": "1",
        "category": "item",
        "description": "<p>Cet ensemble de fioles et de produits chimiques transportables permet d'accomplir des tâches alchimiques simples. Si vous transportez votre matériel d'alchimiste, vous pouvez le sortir et le ranger durant l'action qui permet de l'utiliser.</p>",
        "element_type": "OBJET 0",
    ...
    "7JbiaZ8bxODM5mzS": {
        ...
        "bulk": null,
        "category": "feat",
        "description": "<p>Vous vous spécialisez dans les explosions et les réactions alchimiques violentes.</p>\n<p>\"Formules\" Deux bombes alchimiques courantes de niveau 1.</p>\n<p>\"Avantage de champ de recherche\" Lorsque vous jetez une bombe alchimique avec le trait éclaboussure, vous pouvez choisir d'infliger des dégâts d'éclaboussure uniquement à votre cible primaire au lieu de la zone d'éclaboussure habituelle.</p>\n<p>\"Fioles de champ de recherches\" Lorsque vous Frappez avec une fiole polyvalente, vous pouvez choisir de lui faire infliger des dégâts de froid, d'électricité ou de feu à la place de dégâts d'acide.</p>\n<p>\"Découverte de domaine  (5e)\" Vous avez pris en compte tous les angles pour maximiser l'éclaboussure d'une bombe. Lorsque vous jetez une bombe alchimique avec le trait éclaboussure, vous pouvez faire en sorte que la bombe inflige des dégâts d'éclaboussure égaux à votre modificateur d'Intelligence (minimum 1) au lieu de leur montant normal.</p>\n<p>\"Fioles évoluées  (11e)\" Vous pouvez mélanger des ingrédients spéciaux à l'intérieur de vos fioles, tels que  de la poussière magique ou des paillettes de minéraux précieux. Lorsque vous créez une fiole polyvalente, vous pouvez choisir de la traiter comme étant faite d'un matériau spécial de votre choix, choisi parmi l'adamantium, le fer froid et l'aubargent. Si vous maniez ou portez un objet d'un métal précieux différent lorsque vous faites la fiole, vous pouvez choisir ce matériau à la place.</p>\n<p>\"Découverte de domaine supérieure  (13e)\" Vous pouvez augmenter les éclaboussures de vos bombes pour blesser les créatures dans les 3 mètres ou dans les 4,50 mètres si vous possédez Éclaboussure élargie.</p>",
        "element_type": null,
    ...
    "eNZnx4LISDNftbx2": {
        ...
        "bulk": null,
        "category": "feat",
        "description": "<p>Vous vous concentrez principalement sur les soins que vous apportez aux autres avec votre alchimie.</p>\n<p>\"Formules\" Deux élixirs alchimiques courants de niveau 1 avec le trait guérison (comme l' <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'ktjFOp3U0wQD9t0Z'})\">antidote inférieur</div> , l' <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'UqinuuCWePTYGhVO'})\">antimaladie inférieur</div>  ou l' <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'hDLbR56Id2OtU318'})\">élixir de vie mineur</div> ).</p>\n<p>\"Avantage de champ de recherche\" Vous pouvez utiliser votre degré de maîtrise en Artisanat pour tout ce qui nécessite un degré de maîtrise en Médecine (tels que les prérequis) et utiliser votre modificateur d'Artisanat à la place de votre modificateur de Médecine pour tous les tests de Médecine.</p>\n<p>\"Fioles de champ de recherches\" Vos fioles polyvalentes peuvent être utilisées pour soigner une créature vivante d'un nombre de Points de vie égaux aux dégâts initiaux de vos fioles. Une créature peut boire la fiole pour obtenir cet avantage ou vous pouvez jeter la fiole sur une créature consentante dans les 6 mètres en utilisant une action interagir pour soigner cette créature. Dans l'un ou l'autre cas, une fiole utilisée de cette manière perd les traits acide et éclaboussure et obtient les traits coagulant et guérison, plus le trait élixir si une créature la boit.</p>\n<p>\"Découverte de domaine  (5e)\" Vos élixirs médicinaux sont assez fortifiants. Lorsqu'une créature boit un élixir imprégné avec le trait guérison que vous avez créé, cette créature obtient un nombre de Points de vie temporaires égaux à votre modificateur d'Intelligence (minimum 0). Ces Points de vie temporaires durent pendant 1 minute.</p>\n<p>\"Fioles évoluées  (11e)\" Lorsque vous utilisez une fiole de votre domaine pour soigner une créature qui possède la moitié du maximum de ses Points de vie ou moins, le trait coagulant ne s'applique pas aux soins.</p>\n<p>\"Découverte de domaine supérieure  (13e)\" Lorsque vous utilisez Alchimie rapide pour créer n'importe quel type d'élixir de vie, la créature soignée par l'objet regagne le maximum de Points de vie possibles, au lieu de lancer les dés pour déterminer le nombre de Points de vie regagnés.</p>",
        "element_type": null,
    ...
    "tvdb1jkjl2bRZjSp": {
        ...
        "bulk": null,
        "category": "feat",
        "description": "<p>Vous vous concentrez sur les bizarres transformations mutagènes qui sacrifient un aspect physique ou psychologique d'une créature pour en renforcer un autre.</p>\n<p>\"Formules\" Deux mutagènes alchimiques courants de niveau 1.</p>\n<p>\"Avantage de champ de recherche\" Lorsque vous utilisez un mutagène, vous obtenez un nombre de Points de vie temporaires égal à votre modificateur d'Intelligence (minimum 0) plus la moitié de votre niveau. Ces Points de vie temporaires durent pendant 1 minute ou jusqu'à l'expiration de la durée du mutagène selon ce qui se produit en premier. Vous ne pouvez pas obtenir des Points de vie temporaires en buvant de nouveau un mutagène pendant 1 minute.</p>\n<p>\"Fioles de champ de recherches\" Vous pouvez boire les contenus de l'une de vos fioles polyvalentes pour supprimer l'inconvénient que vous subissez d'un mutagène qui vous affecte actuellement jusqu'au début de votre prochain tour. Une fiole utilisée de cette manière perd les traits acide, bombe et éclaboussure et obtient le trait élixir. Si plus d'un inconvénient lié à  <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'jSkJIWPfSZZzvYzq'})\">Combiner des élixirs</div>  ou une capacité similaire s'applique, boire la fiole supprime un inconvénient de votre choix.</p>\n<p>\"Découverte de domaine  (5e)\" Les mutagènes qui circulent dans votre sang ont altéré votre chimie corporelle. Lorsque vous lancez un jet de Vigueur alors que vous êtes affecté par un mutagène et n'appréciez pas le résultat, vous pouvez mettre un terme à l'effet du mutagène pour relancer le jet de sauvegarde. C'est un effet de fortune.</p>\n<p>\"Fioles évoluées  (11e)\" Lorsque vous buvez une des Fioles de champ de recherches, vous obtenez également une résistance contre les dégâts physiques pendant la même durée. La résistance est égale à la moitié de votre niveau.</p>\n<p>\"Découverte de domaine supérieure  (13e)\" Si vous absorbez un autre mutagène alors que vous êtes sous l'effet d'un mutagène, vous pouvez bénéficier des avantages et des inconvénients des deux mutagènes à la fois, bien qu'ils aient tous deux le trait métamorphose et qu'ils ne devraient pas fonctionner normalement ensemble. Si vous subissez les effets d'un autre mutagène alors que vous bénéficiez de deux mutagènes, vous perdez le bénéfice de l'un des anciens mutagènes de votre choix, tout en conservant les inconvénients de tous les mutagènes. Si vous êtes sous l'effet de deux mutagènes et que vous tombez sous l'effet d'un effet de métamorphose ne résultant pas d'un mutagène, vous perdez les avantages des mutagènes tout en conservant les inconvénients des deux mutagènes. L'avantage de la fiole de domaine s'applique à un mutagène de votre choix.</p>",
        "element_type": null,
