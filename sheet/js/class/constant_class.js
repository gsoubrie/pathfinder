...
var CLASSES = {
        ...
        "abilities": {
            "alchimie": {
                ...
                "description": [
                    ...
                    "Vous obtenez le don <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'is3Oz9wt11lNq62K'})\">Artisanat alchimique</div> et vous pouvez automatiquement identifier les objets alchimiques dont vous disposez de la formule."
                ]
            },
            "recueil_de_formules": {
                "name": "Recueil de formules",
                "description": [
                    "Un alchimiste conserve les formules méticuleusement de tout objet que vous pouvez créer. Vous débutez avec un <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'qCEOZ6109Yo34tRx'})\">Recueil de formules</div> standard gratuitement. Le recueil de formules contient les formules de deux objets alchimiques courants de niveau 1 de votre choix, en plus de toutes les formules que vous avez obtenues par <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'is3Oz9wt11lNq62K'})\">Artisanat alchimique</div> et votre champ de recherche.",
                    "Chaque fois que vous gagnez un niveau, vous pouvez ajouter les formules de deux objets alchimiques courants de votre recueil de formules. Ces nouvelles formules peuvent être de n'importe quel niveau d'objet que vous pouvez créer. Vous apprenez ces formules automatiquement, mais il est aussi possible de trouver et acheter des formules supplémentaires dans les agglomérations ou d'autres alchimistes ou en sélectionnant le don de compétence <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'XR95taODq1sq82Du'})\">Inventeur</div> de sorte à pouvoir les inventer.",
            ...
            "alchimie_rapide": {
                ...
                "description": [
                    "Vous obtenez l'action <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'yzNJgwzV9XqEhKc6'})\">Alchimie rapide</div> pour faire les objets dont vous avez besoin à la volée."
                ]
            },
            "fioles_polyvalentes": {
                ...
                "description": [
                    ...
                    "Les fioles polyvalentes sont des objets imprégnés et sont détruites si elles ne sont pas utilisées à l'occasion de vos prochains préparatifs quotidiens. Une fiole que vous créez est toujours du type le plus élevé que vous pouvez Fabriquer. Voyez les statistiques sur la manière d'utiliser la fiole polyvalente en tant que bombe. Vous pouvez utiliser les fioles dans le cadre de l' <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'sPtl05wwTpqFI0lL'})\">Alchimie rapide</div> et votre champ de recherche peut ajouter des manières dont vous utilisez une fiole.",
                    "Vous pouvez emmagasiner toutes vos fioles polyvalentes au sein de votre <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': '4ftXXUCBHcf4b0MH'})\">Matériel d'alchimiste</div> , sans augmenter son Encombrement. Bien que les fioles polyvalentes soient des objets physiques, elles ne peuvent être dupliquées ou conservées en aucune manière.",
            ...
            "champ_de_recherche": {
                ...
                "description": [
                    ...
                    "<div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': '7JbiaZ8bxODM5mzS'})\">Bombardier</div>",
                    "<div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'eNZnx4LISDNftbx2'})\">Chirurgien</div>",
                    "<div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'tvdb1jkjl2bRZjSp'})\">Mutagéniste</div>",
                    "<div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'P9quO9XZi3OWFe1k'})\">Toxicologiste</div>"
                ]
            },
            "dons_d_alchimiste": {
            ...
            "fioles_abondantes": {
                ...
                "description": [
                    "Vous êtes <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'nlCjDvLMf2EkV2dl'})\">Accéléré</div> de manière permanente et ne pouvez utiliser l'action supplémentaire que pour utiliser <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'yzNJgwzV9XqEhKc6'})\">Alchimie rapide</div> pour créer une fiole rapide. Vous ne pouvez créer qu'une fiole avec cette action, même si vous avez <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': '76cwNLJEm4Yetnee'})\">Double breuvage</div> ou une capacité similaire."
                ],
                "level": 17
            },
            "maitrise_alchimique": {
    ...
    },
    {
        ...
        "abilities": {
            ...
            "impulsif": {
                "name": "Impulsif",
                "description": [
                    "Vous obtenez l'action gratuite <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'a9PzINjFTO5GvAJN'})\">Impulsif</div> , ce qui vous permet d'entrer en <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'Ah5g9pDwWF9b9VW9'})\">Rage</div> à la moindre provocation."
                ]
            },
            "impulsif_f": {
                "name": "Impulsif F",
                "description": [
                    ...
                    "Conditions Vous n'êtes pas <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'D5mg6Tc7Jzrj6ro7'})\">Surchargé</div> et ne portez pas d'armure lourde.",
            ...
            "rage": {
                "name": "Rage",
                "description": [
                    "Vous obtenez l'action <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'Ah5g9pDwWF9b9VW9'})\">Rage</div> qui vous permet de vous déchaîner."
                ]
            },
            "rage_a": {
                "name": "Rage A",
                "description": [
                    "Conditions Vous n'êtes pas <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'HL2l2VRSaQHu9lUw'})\">Fatigué</div> ou en rage.",
                    ...
                    "Vous ne pouvez pas utiliser d'actions avec le trait concentration, sauf si elles possèdent également le trait rage. Vous pouvez <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'BlAOM2X92SI6HMtJ'})\">Chercher</div> pendant que vous êtes enragé.",
                    "La rage dure pendant 1 minute, jusqu'à ce que vous tombiez <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'fBnFDH2MTzgFijKf'})\">Inconscient</div> ou que la rencontre se termine, selon ce qui se produit en premier. Vous ne pouvez pas volontairement mettre fin à votre rage. Quand vous mettez un terme à votre rage, vous perdez tous Points de vie temporaires restants obtenus grâce à la rage et vous ne pouvez plus obtenir de nouveau de Points de vie temporaires en utilisant l'action de Rage de nouveau pendant 1 minute."
                ]
            },
            "instinct": {
                "name": "Instinct",
                "description": [
                    ...
                    "<div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': '0FtzFbUrN56KA67z'})\">Instinct animal</div>",
                    "<div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'znxs0soGlusvRP39'})\">Instinct de décomposition</div>",
                    "<div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'JuKD6k7nDwfO0Ckv'})\">Instinct de géant</div>",
                    "<div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'k7M9jedvt31AJ5ZR'})\">Instinct de la furie</div>",
                    "<div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'VDot7CDcXElxmkkz'})\">Instinct du dragon</div>",
                    "<div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': '0jSS6pgNXsC8k4o7'})\">Instinct élémentaire</div>",
                    "<div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'qVAeSFTI1dq64bB8'})\">Instinct ligneux</div>",
                    "<div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'TQqv9Q5mB4PW6LH9'})\">Instinct spirituel</div>",
                    "<div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'SCYSjUbMmw8JD9P9'})\">Instinct superstitieux</div>"
                ]
            },
            "dons_de_competence": {
                "name": "Dons de compétence",
        ...
        "abilities": {
            ...
            "muses": {
                ...
                "description": [
                    ...
                    "En plus de cela, chaque muse ouvre la porte à nombre de dons de bardes. Si un type d'inspiration n'est pas suffisante pour représenter votre muse, considérez le don <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'a898miJnjgD93ZsX'})\">Muse polyvalente</div>",
                    "<div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'N03BtRvjX9TeHRa4'})\">Combattante</div>",
                    "<div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': '4ripp6EfdVpS0d60'})\">Énigmatique</div>",
                    "<div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'YMBsi4bndRAk5CX4'})\">Maestro</div>",
                    "<div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'y0jGimYdMGDJWrEq'})\">Touche-à-tout</div>",
                    "<div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'jHOlcSnGyjCnwoPP'})\">Zoophonie</div>"
                ]
            },
            "repertoire_de_sorts": {
            ...
            "tours_de_magie_de_composition": {
                ...
                "description": [
                    ...
                    "Vous apprenez le tour de magie de composition <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'IAjvwqgiDr3qGYxY'})\">Hymne de courage</div> qui améliore les attaques, les dégâts et la défense contre la terreur chez vos alliés."
                ]
            },
            "dons_de_barde": {
                "name": "Dons de barde",
    ...
    },
    {
        ...
        "abilities": {
            "aboutissement_assure": {
                ...
                "description": [
                    "Vous obtenez une attaque finale élégante que vous pouvez porter quand vous possédez du panache. Vous obtenez l'action <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'K878asDgf1EF0B9S'})\">Aboutissement assuré</div> ."
                ]
            },
            "combattant_style": {
            ...
            "panache": {
                ...
                "description": [
                    ...
                    "<div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'uBJsxCzNhje8m8jj'})\">Effet : Panache</div>",
                    "Vous obtenez du panache en accomplissant des actions qui possèdent le trait bravade. <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': '21WIfSu7Xd7uKqV8'})\">Déplacement acrobatique</div> et des actions supplémentaires déterminées par votre style de bretteur obtiennent le trait bravade. Le MJ pourrait décider qu'accomplir une action particulièrement osée, comme vous balancer à un chandelier ou glisser le long d'une tenture, peuvent gagner le trait bravade. Ces tests impliquent typiquement au moins une action et un DD qui ne soit pas trivial. Normalement, vous obtenez et utilisez votre panache uniquement lors des rencontres de combat. Lorsqu'une rencontre se termine, vous perdez votre panache.",
                    "De puissantes actions d'aboutissement, comme <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'K878asDgf1EF0B9S'})\">Aboutissement assuré</div> , ne peuvent être utilisées que si vous disposez de panache et elles vous font perdre du panache."
                ]
            },
            "style_de_bretteur": {
            ...
            "riposte_opportune": {
                ...
                "description": [
                    "Vous renversez la situation quand des ennemis font un faux pas en combat, profitant immédiatement de leur erreur. Vous gagnez la réaction <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'EfjoIuDmtUn4yiow'})\">Riposte opportune</div> ."
                ],
                "level": 3
            },
            "vitesse_exuberante": {
            ...
            "aboutissement_exemplaire": {
                ...
                "description": [
                    ...
                    "Danseur de combat Vous pouvez <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'UHpkTuCtyaPqiCAB'})\">Faire un pas</div> en utilisant une action gratuite immédiatement après l'aboutissement.",
                    "Escrimeur L'ennemi est <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'AJh5ex99aV6VTggg'})\">Pris au dépourvu</div> jusqu'à votre prochain tour.",
                    "Esprit L'ennemi subit une pénalité de circonstances de -2 aux jets d'attaques contre vous jusqu'au début de votre prochain tour. <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'cu10OjQUdY0a9gpj'})\">Effet : Aboutissement exemplaire - Esprit</div>",
                    "Fanfaron Si l'ennemi était temporairement immunisé à vos tentatives de <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': '2u915NdUyQan6uKF'})\">Démoralisation</div> , cette immunité temporaire prend fin.",
                    "Fripouille L'ennemi subit une pénalité de circonstances de -3 mètres à sa vitesse jusqu'au début de votre prochain tour. <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'fgz7lwg1xHsVW4dX'})\">Effet : Aboutissement exemplaire - Fripouille</div>",
                    "Gymnaste Si l'ennemi est <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'kWc1fhmv9LBiTuei'})\">Agrippé</div> , <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'VcDeM8A5oI6VqhbM'})\">Entravé</div> ou <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'j91X7x0XSomq8d60'})\">À terre</div> , vous obtenez un bonus de circonstances aux dégâts égal à deux fois le nombre de dés de dégâts de votre arme."
                ],
                "level": 9
            },
            ...
            "confiance_eternelle": {
                ...
                "description": [
                    ...
                    "Lorsque vous faites une Frappe comme partie d'un aboutissement ou d'une <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'EfjoIuDmtUn4yiow'})\">Riposte opportune</div> , vous pouvez donner à la Frappe l'effet d'échec du <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'pyo0vmxUFIFX2GNl'})\">Aboutissement assuré</div> , incluant l'augmentation provenant de <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'qeLpqH2cMSmIrILV'})\">Aboutissement précis</div> si vous possédez ce don.",
                    "Vous ne pouvez profiter de cet avantage que si vous utilisez une arme ou une attaque sans arme pour la Frappe avec laquelle vous pouvez utiliser <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'qeLpqH2cMSmIrILV'})\">Aboutissement assuré</div> ."
                ],
                "level": 17
            },
    ...
    },
    {
        ...
        "abilities": {
            "blocage_au_bouclier": {
                ...
                "description": [
                    "Vous obtenez le don général <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'jM72TjJ965jocBV8'})\">Blocage au bouclier</div> , une réaction qui vous permet de réduire les dégâts avec votre bouclier."
                ]
            },
            "cause": {
                "name": "Cause",
                "description": [
                    ...
                    "<div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'h1NGH4TVeBljftni'})\">Grandeur</div> (Saint) : Vous illustrez la gloire et la splendeur des royaumes célestes.",
                    "<div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'EQ6DVIQHAUXUhY6Y'})\">Iniquité</div> (Impie) : Vous détruisez, tirez parti et agissez avec déshonneur.",
                    "<div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'peEXunfbSD8WcMFk'})\">Justice</div> : Vous respectez les lois et infligez un juste châtiment.",
                    "<div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'FCoMFUsth4xB4veC'})\">Libération</div> : Vous vous opposez à la tyrannie et combattent pour la liberté.",
                    "<div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'HiIvez0TqESbleB5'})\">Obéissance</div> : Vous respectez la hiérarchie et l'ordre.",
                    "<div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': '8YIA0jh64Ecz0TG6'})\">Profanation</div> (Impie) : Vous corrompez égoïstement et détruisez.",
                    "<div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'UyuwFp0jQqYL2AdF'})\">Rédemption</div> (Saint) : Vous tentez de racheter ceux qui commettent de mauvaises actions."
                ]
            },
            "divinite": {
                "name": "Divinité",
            ...
            "sorts_de_devotion": {
                ...
                "description": [
                    "La puissance de votre divinité vous confère des sorts divins spéciaux appelés sorts de dévotion qui sont un type de sorts focalisés. Choisissez soit <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'ZL97DcoJ8us6EwAF'})\">Boucliers de l'esprit</div> , soit un sort basé sur la source divine de votre divinité ( <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'zNN9212H2FGfM7VS'})\">Imposition des mains</div> si votre divinité autorise Guérison, soit <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'jFmWSIpJGGebim6y'})\">Toucher du vide</div> si votre divinité autorise Mise à mal).",
            ...
            "benediction_du_devot": {
                ...
                "description": [
                    ...
                    "Arme bénie Choisissez une arme ou des <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'FNDq4NFSN0g2HKWO'})\">Bandelettes de coups puissants</div> . Vous obtenez l'effet critique spécialisé de cette arme et vous lui allouez une rune de propriété de votre choix dans la liste suivante : <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'qlunQzfnzPQpMG6U'})\">Boomerang</div> , <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'P6v2AtJw7AUwaDzf'})\">Effrayante</div> , <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'JQdwHECogcTzdd8R'})\">Spectrale</div> , <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'roeYtwlIe65BPMJ1'})\">Changeante</div> ou <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'LwQb7ryTC8FlOXgX'})\">Vitalisante</div> . Au cours de vos préparatifs quotidiens, vous pouvez changer l'esprit pour qu'il vienne habiter un armement différent, qu'il accorde une rune différente ou les deux.",
                    "Bouclier béni Entre vos mains, un bouclier obtient la rune <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'x9SNVpAAnXKJeoqp'})\">Renforcement</div> mineure. Au fur et à mesure que vous gagnez des niveaux, le bouclier obtient la rune Renforcement de votre niveau (inférieur au niveau 7, modéré au niveau 10, supérieur au niveau 13, majeur au niveau 16 et ultime au niveau 19). Si votre bouclier possède la rune de Renforcement de votre niveau ou s'il s'agit d'un <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'f9ygr5Cjrmop8LWV'})\">Bouclier renforcé</div> du même niveau que la rune de Renforcement appropriée, la Solidité du bouclier augmente de 1 à la place.",
            ...
            "defi_du_heros": {
                "name": "Défi du héros",
                "description": [
                    "Vous pouvez continuer à combattre tant qu'il vous reste de l'énergie divine. Vous obtenez le sort de dévotion <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'uGXWkR2h8q9MRzEM'})\">Défi du héros</div> ."
                ],
                "level": 19
            }
        }
        ...
        "abilities": {
            ...
            "ordre_druidique": {
                ...
                "description": [
                    ...
                    "<div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'POBvoXifa9HaejAg'})\">Ordre animal</div>",
                    "<div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'u4nlOzPj2WHkIj9l'})\">Ordre de la feuille</div> et ses variantes <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'X0k3njLOLX0322Po'})\">Ordre des spores</div> et <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'IiYUhFGqq2Nw0b5Y'})\">Ordre du cultivateur</div>",
                    "<div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'NdeFvIXdHwKYLiUj'})\">Ordre de la flamme</div>",
                    "<div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'fKTewWlYgFuhl4KA'})\">Ordre de la pierre</div>",
                    "<div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'acqqlYmti8D9QJi0'})\">Ordre de la tempête</div>",
                    "<div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'FuUXyv2yBs7zRgqT'})\">Ordre de la vague</div>",
                    "<div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'v0EjtiwdeMj8ykI0'})\">Ordre indompté</div>"
                ]
            },
            "voix_de_la_nature": {
                "name": "Voix de la nature",
                "description": [
                    "Vous obtenez au choix <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'cg816q76S5otM7yD'})\">Empathie animale</div> ou <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'ahyQpMVDIqhvXkQ4'})\">Empathie avec les plantes</div> en tant que don de druide."
                ]
            },
            "dons_de_competence": {
                "name": "Dons de compétence",
        ...
        "abilities": {
            "concevoir_un_stratageme": {
                ...
                "description": [
                    ...
                    "Vous obtenez l'action <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'm0f2B7G9eaaTmhFL'})\">Concevoir un stratagème</div>",
                    "Vous obtenez l'action <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'm0f2B7G9eaaTmhFL'})\">Concevoir un stratagème</div>"
                ]
            },
            "dons_d_enqueteur": {
            ...
            "frappe_strategique": {
                ...
                "description": [
                    "Quand vous portez une attaque avec grand soin et en la préparant, vous infligez un coup plus significatif. Quand vous effectuez une Frappe qui ajoute votre modificateur d'Intelligence au jet d'attaque grâce à <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'lgo65ldX7WkXC8Ir'})\">Concevoir un stratagème</div> , vous infligez 1d6 dégâts de précision supplémentaires.",
            ...
            "methodologie": {
                ...
                "description": [
                    ...
                    "<div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'g3mNzNphtVxyR9Xr'})\">Empirisme</div>",
                    "<div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'UIHUNNYZyQ3p4Vmo'})\">Interrogatoire</div>",
                    "<div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'O3IX7rTxXWWvDVM3'})\">Médecine forensique</div>",
                    "<div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'ln2Y1a4SxlU9sizX'})\">Sciences alchimiques</div>"
                ]
            },
            "sur_l_affaire": {
                "name": "Sur l'affaire",
                "description": [
                    "En tant qu'investigateur, vous considérez vos aventures comme des affaires qui n'attendent que d'être résolues. Vous obtenez une activité et une réaction que vous pouvez utiliser pour enquêter sur vos affaires : <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'xTK2zsWFyxSJvYbX'})\">Suivre une piste</div> et <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': '25WDi1cVUrW92sUj'})\">Partager les indices</div> ."
                ]
            },
            "dons_de_competence": {
                "name": "Dons de compétence",
            ...
            "souvenirs_affutes": {
                ...
                "description": [
                    "Vous pouvez vous souvenir de faits pertinents sur des sujets qui ne sont pas votre spécialité. Votre bonus de maîtrise pour les tests visant à <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': '1OagaWtBpVXExToo'})\">Vous souvenir</div> dans des compétences pour lesquelles vous n'êtes pas qualifié est égal à votre niveau au lieu de +0."
                ],
                "level": 3
            },
            "dons_ancestraux": {
            ...
            "expertise_de_l_enqueteur": {
                ...
                "description": [
                    "Vous avez affiné vos techniques d'investigation à un degré exceptionnel. Le bonus de circonstances obtenu grâce à <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'xTK2zsWFyxSJvYbX'})\">Suivre une piste</div> passe à +2. Votre degré de maîtrise pour le DD de classe d'enquêteur passe à expert."
                ],
                "level": 9
            },
        ...
        "abilities": {
            ...
            "lignage": {
                ...
                "description": [
                    ...
                    "<div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': '3qqvnC2U8W26yae7'})\">Aberrant</div> une étrange et incompréhensible influence vous transmet des sorts occultes.",
                    "<div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'TFihgf3jDhmKd0fa'})\">Aesir</div> L'un de vos ancètres a été touché par un aesir et maintenant le fracas de l'acier contre l'acier et l'appel constant à se battre fait écho dans votre sang.",
                    "<div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'vhW3glAaEfq2DKrw'})\">Angélique</div> la grâce divine vous accorde des sorts divins.",
                    "<div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'dKTb959aCQIzSIXj'})\">Béni du ver</div> la puissance draconique sacrée vous accorde des sorts divins.",
                    "<div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'w5koctOVrEcpxTIq'})\">Démoniaque</div> une corruption impure vous confère des sorts divins.",
                    "<div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'o39zQMIdERWtmBSB'})\">Diabolique</div> un lien avec les diables vous octroie des sorts divins.",
                    "<div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'ZHabYxSgYK0XbjhM'})\">Draconique</div> le sang des dragons vous attribue des sorts arcaniques.",
                    "<div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'RXRnJcG4XSabZ35a'})\">Élémentaire</div> la puissance des éléments se manifeste en vous sous la forme de sorts primordiaux.",
                    "<div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'eW3cfCH7Wpx2vik2'})\">Féerique</div> l'influence des fées vous confère des sorts primordiaux.",
                    "<div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'tYOMBiH3HbViNWwn'})\">Génie</div> l'influence des génies vous confère des sorts arcaniques.",
                    "<div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'O0uXZRWMNliDbkxU'})\">Guenaude</div> la corruption d'une guenaude vous procure des sorts occultes.",
                    "<div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'ZEtJJ5UOlV5oTWWp'})\">Impérial</div> une puissance ancienne vous octroie des sorts arcaniques.",
                    "<div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': '7WBZ2kkhZ7JorWu2'})\">Mort-vivant</div> le contact de la mort vous confère des sorts divins.",
                    "<div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': '5Wxjghw7lHuCxjZz'})\">Nymphe</div> l'influence des nymphes vous confère des sorts primordiaux.",
                    "<div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'uoQOm41BVdSo6pAS'})\">Ombre</div> l'influence du Nébulmonde vous confère des sorts occultes.",
                    "<div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'TWR1wbPJuCLnGdFZ'})\">Phénix</div> l'influence du phénix vous confère des sorts primordiaux.",
                    "<div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'PpzH9tJULk5ksX9w'})\">Psychopompe</div> l'influence des psychopompes vous confère des sorts divins.",
                    "<div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'b6hyZTs1rVGHDexz'})\">Tourment</div> Vous possédez un lien profond avec le Tourment."
                ]
            },
            "primes_d_attributs": {
                "name": "Primes d'attributs",
            ...
            "description_d_un_lignage": {
                ...
                "description": [
                    ...
                    "Legs d'ensorceleur Vous ajoutez automatiquement les sorts indiqués ici à votre répertoire de sorts, comme indiqué dans la capacité <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'lURKSJZAGKVD6cH9'})\">Répertoire de sorts</div> . Au niveau 1, vous obtenez un tour de magie et un sort de rang 1. Vous apprenez les autres sorts sur la liste dès que vous obtenez la capacité de lancer des sorts d'ensorceleur de ce rang.",
                    "Sorts de lignage Vous obtenez automatiquement le sort de lignage initial au rang 1 et vous pouvez en obtenir davantage en prenant les dons <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'eZrftEihfuJBldG5'})\">Lignage avancé</div> et <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'DpRMdytpPiCypmkJ'})\">Lignage supérieur</div> .",
    ...
    },
    {
        ...
        "abilities": {
            ...
            "frappe_reactive": {
                ...
                "description": [
                    "Toujours à l'affût de la moindre faiblesse, vous attaquez aussitôt qu'une faille s'ouvre dans la défense de vos ennemis. Vous obtenez la réaction <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'KAVf7AmRnbCAHrkT'})\">Frappe réactive</div> .",
                    "<div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'KAVf7AmRnbCAHrkT'})\">Frappe réactive</div> R",
            ...
            "bravoure": {
                "name": "Bravoure",
                "description": [
                    "Après avoir affronté d'innombrables ennemis et le chaos de la bataille, vous avez appris à rester fort face à la peur. Vous devenez expert en jet de Volonté. Lorsque vous obtenez un succès sur un jet de Volonté contre un effet de terreur, il devient un succès critique. De plus, chaque fois que vous obtenez l'état <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'TBSHQspnbcqxsmjL'})\">Effrayé</div> , réduisez sa valeur de 1."
                ],
                "level": 3
            },
            "dons_generaux": {
    ...
    },
    {
        ...
        "life_point_by_level": 6,
        "desc_fight": "Vous essayez probablement de rester loin de la mêlée, en appréciant soigneusement le moment pour utiliser vos sorts. Vous conservez votre magie la plus puissante pour mettre hors de combat les adversaires menaçants et utilisez vos tours de magie quand il ne reste que des adversaires faibles. Quand des ennemis utilisent des ruses comme <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'XXqE1eY3w3z6xJCB'})\">Invisibilité</div> ou <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'A2JfEKe6BZcTG1S8'})\">Vol</div> , vous répondez par des sorts comme <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': '0qaqksrGGDj74HXE'})\">Lumière révélatrice</div> ou <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'gPvtmKMRpg9I9D7H'})\">Cloué à terre</div> , ce qui permet à vos alliés d'être à pied d'égalité.",
        ...
        "abilities": {
            "ecole_arcanique": {
                ...
                "description": [
                    "La plupart des magiciens acquièrent leurs connaissances des sorts par le biais d'un enseignement éducatif formel, dispensés dans un établissement tel que l'Arcanamirium ou le Magaambya. Au niveau 1, vous choisissez votre <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'kzxu2dI7tFxv6Ix6.JournalEntryPage.wDukeO3euLEGn6FA#arcane-schools'})\">école arcanique</div> qui vous accorde vos capacités magiques.",
            ...
            "lien_arcanique": {
                "name": "Lien arcanique",
                "description": [
                    "Vous placez une partie de votre puissance magique dans un objet lié. Chaque jour lorsque vous préparez vos sorts, vous pouvez désigner un unique objet en votre possession comme votre objet lié. Il s'agit en général d'un objet associé à l'incantation, comme une baguette, un anneau ou un bâton, mais vous êtes libre de choisir une arme ou autre chose. Vous obtenez l'action gratuite <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'v82XtjAVN4ffgVVR'})\">Drain d'objet lié</div> ."
                ]
            },
            "div_class_gs_link_information_onclick_controller_main_doactionafter_event_show_information_param_information_uuid_v82xtjavn4ffgvvr_drain_d_objet_lie_div_f": {
                "name": "<div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'v82XtjAVN4ffgVVR'})\">Drain d'objet lié</div> F",
                "description": [
            ...
            "these_arcanique": {
                ...
                "description": [
                    ...
                    "<div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'Klb35AwlkNrq1gpB'})\">Bâton nexus</div>",
                    "<div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': '89zWKD2CN7nRu2xp'})\">Expérimentation mutamagique</div>",
                    "<div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'SNZ46g3u7U6x0XJj'})\">Harmonisation avec le familier améliorée</div>",
                    "<div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'OAcxS625AXSGrQIC'})\">Mélange de sorts</div>",
                    "<div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'QzWXMCSGNfvvpYgF'})\">Substitution de sort</div>"
                ]
            },
            "dons_de_competence": {
                "name": "Dons de compétence",
            ...
            "incantateur_legendaire": {
                ...
                "description": [
                    ...
                    "<div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'ZBFICTkzUjE4BDGJ'})\">École de forme protéenne</div>",
                    "<div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'jtAqb5rnhQblZuM8'})\">École de Kalistrade</div>",
                    "<div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'ZpFCZnVzIfZLfNii'})\">École de la frontière</div>",
                    "<div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'YZ2XPmx1WHyWtM0g'})\">École de magie civique</div>",
                    "<div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'wObrT6PytPdS5aUi'})\">École des lettres</div>",
                    "<div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'XXnGHBxNZvRsdkKM'})\">École des portails</div>",
                    "<div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'dPAwM9IdabdH68mW'})\">École des technologies magiques</div>",
                    "<div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'L5FiuXsfW6Sa31gO'})\">École du mentalisme</div>",
                    "<div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'xYYhJtGhFSWNifcO'})\">École de la théorie magique unifiée</div>",
                    "peu courant",
                    "<div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'n2LRzksKVSzOuzqN'})\">École de la récupération</div>",
                    "<div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'KGkWSv9rARpwWzXW'})\">École de la sagesse enracinée</div> qui permet d'accéder à un tronc primaire et à l'une des cinq branches du Magaambya.",
                    ...
                    "L'Élémentaliste vous donne accès à la <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'pUkUC8HHom2DmYzz'})\">Magie élémentaire</div> et vous permet de choisir éventuellement l' <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': '5rFzX6JK6CXLFxUP'})\">École élémentaire</div>",
                    "peu courant",
                    "Le Mage de guerre vous donne accès à la <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'vky5bQfK7SG3uOMA'})\">Magie de guerre</div> et à l' <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'E4GZDMn4DYk6qSEV'})\">École de la magie de combat</div>",
                    "rare",
                    "Le <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'HYTaibaCGE85rhbZ'})\">Seigneur des runes</div> vous donne accès à l' <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'aYWPtW5T4Lx07Occ'})\">École de la magie runique thassilonienne</div>"
                ],
                "level": 19
            }
        }
    },
    {
        ...
        "abilities": {
            ...
            "div_class_gs_link_information_onclick_controller_main_doactionafter_event_show_information_param_information_uuid_nbfnetdpee8cvm17_deluge_de_coups_div_a": {
                "name": "<div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'nbfNETdpee8CVM17'})\">Déluge de coups</div> A",
                "description": [
            ...
            "frappes_mystiques": {
                ...
                "description": [
                    "Vous vous focalisez avec détermination sur vos attaques physiques, ce qui les imprègne d'énergie mystique. Vos attaques à mains nues deviennent magiques, ce qui vous permet d'ignorer les résistances aux attaques non magiques. Toutefois, des objets, tels que les <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'FNDq4NFSN0g2HKWO'})\">Bandelettes de coups puissants</div> , seront toujours nécessaires si vous voulez bénéficier d'un bonus d'objet aux jets d'attaque ou augmenter les dés de dégâts d'arme de vos attaques."
                ],
                "level": 3
            },
            "dons_ancestraux": {
        ...
        "abilities": {
            ...
            "mystere": {
                ...
                "description": [
                    ...
                    "<div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'qvRlih3u7vK3FYUR'})\">Ancêtres</div> Les voix des générations précédentes vous enseignent et vous hantent.",
                    "<div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'g3HTg0z3doXZZzAV'})\">Cendres</div> Vous considérez toutes les choses du monde comme passagères et temporaires, attendant d'être purifiées jusqu'à leur essence de base : la cendre laissée après un feu intense.",
                    "<div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'gjOGOR30Czpnx3tM'})\">Combat</div> Vous incarnez les vertus des héros de légende.",
                    "<div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'RI2EMRBBPNSoTJXu'})\">Cosmos</div> Vous tirez votre puissance des étoiles et de l'espace qui les séparent.",
                    "<div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': '1PHDn7WJFtR3NgTr'})\">Décrépitude</div> Un bourgeon de printemps se fane, un chêne puissant s'écrase sur le sol de la forêt et un novice grandit jusqu'à la maturité, puis décline vers la vieillesse.",
                    "<div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'GTSvbFb36InvuH0w'})\">Flammes</div> Vous dansez avec le feu et faites de votre mieux pour ne pas vous y brûler.",
                    "<div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'IaxmCkdsPlA52spu'})\">Ossements</div> La mort semble toujours proche et les morts vous parlent.",
                    "<div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'tZBb3Kh4nJcNoUFI'})\">Savoir</div> Vous obtenez un accès à une connaissance sans pareille mais écrasante.",
                    "<div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'W9cF7wZztLDb1WGY'})\">Tempête</div> Le vent, les vagues et les tempêtes se déchaînent sur vous.",
                    "<div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'EslxR2sbDK9XJaAl'})\">Temps</div> Que ce soit par accident, par le destin ou par le jeu d'une intervention délibérée, vous existez légèrement en dehors du temps.",
                    "<div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'o1gGG36wpn9mxeop'})\">Vie</div> Les énergies foisonnantes de la vie s'écoulent à travers vous vers le monde."
                ]
            },
            "lire_une_description_de_mystere": {
                ...
                "description": [
                    ...
                    "Sorts de révélation Vous obtenez automatiquement le sort de révélation initial de votre mystère au niveau 1 et pouvez en gagner d'autres en choisissant les dons d'oracle <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'FPVe3o7YctBicSQa'})\">Révélation avancée</div> , <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'HSW3N9pfHhM7upRB'})\">Révélation supérieure</div> et <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': '2HeRmbcHcsRMccir'})\">Mystère diversifié</div> .",
            ...
            "malediction_majeure": {
                ...
                "description": [
                    "Vous avez appris à mieux équilibrer les puissances opposées qui dévastent votre corps. La valeur maximale de votre état <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'zXZjC8HLaRoLR17U'})\">Lié à la malédiction</div> passe de Lié à la malédiction 2 à Lié à la malédiction 3."
                ],
                "level": 11
            },
            "sens_oraculaires": {
            ...
            "malediction_extreme": {
                ...
                "description": [
                    "Vous avez maîtrisé un équilibre précaire entre les pouvoirs divins opposés de votre mystère, ce qui vous permet de tolérer un niveau périlleux de malédiction divine. La valeur maximale de votre état <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'zXZjC8HLaRoLR17U'})\">Lié à la malédiction</div> passe de Lié à la malédiction 3 à Lié à la malédiction 4."
                ],
                "level": 17
            },
        ...
        "abilities": {
            ...
            "doctrine": {
                ...
                "description": [
                    ...
                    "<div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'ZZzLMOUAtBVgV1DF'})\">Prêtre cloîtré</div>",
                    "<div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': '0Aocw3igLwna9cjp'})\">Prêtre combattant</div> ."
                ]
            },
            "pretre_cloitre": {
                "name": "Prêtre cloîtré",
                "description": [
                    ...
                    "Première doctrine (1er) vous obtenez le don de prêtre <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'hT4INKGtly4QY8KN'})\">Initié du domaine</div> .",
    ...
    },
    {
        ...
        "abilities": {
            "chasser_une_proie": {
                ...
                "description": [
                    "Quand vous concentrez votre attention sur un unique adversaire, plus rien ne peut vous empêcher de le traquer. Vous obtenez l'action <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'JYi4MnsdFu618hPm'})\">Chasser une proie</div> ."
                ]
            },
            "div_class_gs_link_information_onclick_controller_main_doactionafter_event_show_information_param_information_uuid_jyi4mnsdfu618hpm_chasser_une_proie_div_1": {
                "name": "<div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'JYi4MnsdFu618hPm'})\">Chasser une proie</div> 1",
                "description": [
            ...
            "specialite_du_chasseur": {
                ...
                "description": [
                    ...
                    "<div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': '6v4Rj7wWfOH1882r'})\">Déluge</div>",
                    "<div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'u6cBjqz2fiRBadBt'})\">Précision</div>",
                    "<div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'NBHyoTrI8q62uDsU'})\">Ruse</div>"
                ]
            },
            "dons_de_competence": {
                "name": "Dons de compétence",
            ...
            "parcours_sans_traces": {
                ...
                "description": [
                    "Lorsque vous traversez des terrains naturels, vous êtes difficile à pister. Vous obtenez en permanence des avantages de l'action <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'SB7cMECVtE06kByk'})\">Dissimuler des traces</div> sur de tels terrains, sans devoir vous déplacer à la moitié de votre Vitesse."
                ],
                "level": 5
            },
            "primes_d_attributs": {
            ...
            "avantage_naturel": {
                ...
                "description": [
                    "Vous trouvez toujours les points faibles dans les défenses de vos ennemis quand ils se trouvent sur un terrain défavorable. Les ennemis sont <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'AJh5ex99aV6VTggg'})\">Pris au dépourvu</div> à votre égard lorsqu'ils se trouvent sur un terrain difficile."
                ],
                "level": 9
            },
            "expertise_du_rodeur": {
            ...
            "maitre_chasseur": {
                ...
                "description": [
                    ...
                    "Si vous êtes un maître en Perception, vous bénéficiez d'un bonus de circonstances de +4 aux tests de Perception quand vous <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'BlAOM2X92SI6HMtJ'})\">Cherchez</div> votre proie et si vous êtes un maître en Survie, vous bénéficiez d'un bonus de circonstances de +4 aux tests de Survie lorsque vous <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'EA5vuSgJfiHH7plD'})\">Pistez</div> votre proie. Vous bénéficiez également d'un avantage supplémentaire qui dépend de votre spécialité du chasseur.",
            ...
            "proie_rapide": {
                "name": "Proie rapide",
                "description": [
                    "Vous jaugez votre proie d'un simple coup d'œil. Vous pouvez utiliser <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'JYi4MnsdFu618hPm'})\">Chasser une proie</div> par une action gratuite si c'est la première action de votre tour."
                ],
                "level": 19
            }
        }
    },
    {
        ...
        "abilities": {
            ...
            "attaque_surprise": {
                ...
                "description": [
                    "Vous agissez avant que vos adversaires ne réagissent. Lors du premier round de combat, si vous utilisez la Duperie ou la Discrétion pour déterminer l'initiative, les créatures qui n'ont pas encore agi sont <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'AJh5ex99aV6VTggg'})\">Prises au dépourvu</div> à votre égard."
                ],
                "required": {
                    "archetypes": [
                        {
            ...
            "trafic_de_roublard": {
                ...
                "description": [
                    ...
                    "<div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'D8qtAo2w4jsqjBrM'})\">Mystificateur</div>",
                    "<div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'ZvfxtUMtfIOLYHyg'})\">Scélérat</div>",
                    "<div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'RyOkmu0W9svavuAB'})\">Stratège</div>",
                    "<div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'wAh2riuFRzz0edPl'})\">Voleur</div>",
                    "<div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': '3KPZ7svIO6kmmEKH'})\">Voyou</div>"
                ]
            },
            "ameliorations_de_competence": {
                "name": "Améliorations de compétence",
            ...
            "refus_d_avantage": {
                ...
                "description": [
                    "Comme vous profitez des ouvertures dans la défense des autres, vous veillez à ne pas en laisser vous-même. Vous n'êtes pas <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'AJh5ex99aV6VTggg'})\">Pris au dépourvu</div> par les créatures qui sont <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'iU0fEDdBp3rXpTMC'})\">Cachées</div> , <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'VRSef5y1LmL2Hkjf'})\">Non détectées</div> ou qui vous prennent en tenaille si elles sont d'un niveau inférieur ou égal au vôtre, ni par les créatures d'un niveau inférieur ou égal au vôtre qui utilisent Attaque surprise. Cependant, ces créatures peuvent toujours aider leurs alliés à vous prendre en tenaille."
                ],
                "level": 3
            },
            "dons_generaux": {
            ...
            "astuces_martiales": {
                ...
                "description": [
                    "Votre degré de maîtrise avec les attaques à mains nues, les armes simples et les armes de guerre passe à expert. Lorsque vous obtenez un coup critique sur un jet d'attaque contre une créature <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'AJh5ex99aV6VTggg'})\">Prise au dépourvu</div> alors que vous utilisez une arme ou une attaque à mains nues ayant les traits agile ou finesse, vous appliquez l'effet critique spécialisé de l'arme ou de l'attaque à mains nues que vous maniez."
                ],
                "level": 5
            },
            "dons_ancestraux": {
            ...
            "div_class_gs_link_information_onclick_controller_main_doactionafter_event_show_information_param_information_uuid_bp0up04x3dzgk5bb_frappe_incapacitante_div_f": {
                "name": "<div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'bp0Up04x3dzGK5bB'})\">Frappe incapacitante</div> F",
                "description": [
                    ...
                    "Handicap La cible devient <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'MIRkyAjyBeXivMa7'})\">Affaiblie 1</div> ."
                ]
            },
            ...
            "frappe_de_maitre": {
                ...
                "description": [
                    "Vous pouvez mettre hors de combat un ennemi distrait en lui assénant une unique frappe. Votre degré de maîtrise dans le DD de classe de roublard passe à maître. Vous obtenez l'action gratuite <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'Rlp7ND33yYfxiEWi'})\">Frappe de maître</div> ."
                ],
                "level": 19
            },
            "div_class_gs_link_information_onclick_controller_main_doactionafter_event_show_information_param_information_uuid_rlp7nd33yyfxiewi_frappe_de_maitre_div_f": {
                "name": "<div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'Rlp7ND33yYfxiEWi'})\">Frappe de maître</div> F",
                "description": [
                    "Déclencheur Vous réussissez une Frappe contre une créature <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'AJh5ex99aV6VTggg'})\">Prise au dépourvu</div> et lui infligez des dégâts.",
                    ...
                    "Succès La cible est <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'MIRkyAjyBeXivMa7'})\">Affaiblie 2</div> jusqu'à la fin de votre prochain tour.",
                    "Échec La cible est <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': '6uEgoh53GbXuHpTF'})\">Paralysée</div> pendant 4 rounds.",
                    "Échec critique La cible est Paralysée pendant 4 rounds, se trouve dans l'état <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'fBnFDH2MTzgFijKf'})\">Inconscient</div> pendant 2 heures ou est tuée (à vous de décider)."
                ]
            },
            "maitrise_des_armures_legeres": {
                "name": "Maîtrise des armures légères",
        ...
        "abilities": {
            ...
            "sorts_de_malefice": {
                ...
                "description": [
                    ...
                    "À votre choix, vous apprenez le maléfice <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'aq1yonHeYpbaj3XI'})\">Poupée du patron</div> ou le maléfice <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'rMOI8JFJ0nT2mrCF'})\">Déphasage de familier</div> qui vous permettent respectivement de diriger votre familier ou de le défendre contre ce qui pourrait lui causer du tort. Vous apprenez la plupart des autres maléfices par le biais des <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'SOan0fqyFTrkqJLV'})\">Leçons du sorcier</div> ."
                ]
            },
            "tours_de_magie_de_malefice": {
                ...
                "description": [
                    ...
                    "Vous obtenez un tour de magie de maléfice déterminé par le choix de votre <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'nocYmxbi4rqCC2qS'})\">Thème de patron</div> ."
                ]
            },
            "dons_de_competence": {
                "name": "Dons de compétence",
            ...
            "patrons": {
                ...
                "description": [
                    ...
                    "<div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'v2JQB6j3VIKWqPpQ'})\">Choeur politique</div>",
                    "<div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'T9wA833bzZVlB3Lo'})\">Dévoreur de pourriture</div>",
                    "<div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'mFqMSQoNl0NMDklv'})\">Gardien de la flamme de la foi</div>",
                    "<div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'e0VhUyjz1clW3sC4'})\">Intendant de la nature</div>",
                    "<div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'FdLx4VODZEYLGOK9'})\">L'inscrit</div>",
                    "<div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'ydI39ViUy22nBRn6'})\">Le courtier invisible</div>",
                    "<div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': '9OwWgOP8ZWxTAqbg'})\">Le ressentiment</div>",
                    "<div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': '4zE3seVFtLPNw9EQ'})\">Murmure des ailes</div>",
                    "<div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'zy0toWeGIeQstbT4'})\">Moustique</div>",
                    "<div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'r2ZPRAw9c3VGZi8A'})\">Ombre sans étoile</div>",
                    "<div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'lgv4VIoj5TLhm9u0'})\">Ondulation dans les profondeurs</div>",
                    "<div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'RdOzBNPKLTMUWrJs'})\">Paradoxe des opposés</div>",
                    "<div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': '9c57R18pfgfqlBCD'})\">Silence dans la neige</div>",
                    "<div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'ghIsqhEsJTvjJiNl'})\">Tisseur de fils</div>",
                    "Rare",
                    "<div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'VVMMJdIWL7fAsQf3'})\">Baba Yaga</div>"
                ]
            },
            "lecons_de_sorcier": {
                ...
                "description": [
                    ...
                    "Leçon des éléments Les catastrophes naturelles et les intempéries ont plus de pouvoir que la plus puissante des créatures. Vous obtenez le maléfice <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'f9uqHnNBMU0774SF'})\">Trahison élémentaire</div> . Votre familier apprend à votre choix soit <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'W69zswpj0Trdy5rj'})\">Bulle d'air</div> , <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'y6rAdMK6EFlV6U0t'})\">Cracher du feu</div> , <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'Rn2LkoSq1XhLsODV'})\">Frappe de débris</div> ou <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'jfVCuOpzC6mUrf6f'})\">Poussée hydraulique</div> .",
                    "Leçon de protection Une dose de protection vaut mieux que son poids en remèdes. Vous obtenez le maléfice <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'dFejDNEmVj3CwYLL'})\">Protection du sang</div> et votre familier apprend <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'aAbfKn8maGjJjk2W'})\">Armure mystique</div> .",
                    "Leçon des rêves Les rêves peuvent être une fenêtre vers des intuitions supérieures. Vous obtenez le maléfice <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'NNoKWiWKqJkdD2ln'})\">Voile des rêves</div> et votre familier apprend <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'o4lRVTwSxnOOn5vl'})\">Sommeil</div> .",
                    "Leçon de vengeance Ne pas souffrir le moindre affront. Vous obtenez le maléfice <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'aEitTTb9PnOyidRf'})\">Aiguillon de la vengeance</div> et votre familier apprend <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'R8bqnYiThB6MYTxD'})\">Douleur fantôme</div> .",
                    "Leçon de vie La vie peut être partagée. Vous obtenez le maléfice <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'fAlzXtQAASaJx0mY'})\">Gain de vie</div> et votre familier apprend <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'yHujiDQPdtXW797e'})\">Lien spirituel</div> .",
                    "Peu courant",
                    "Leçon de calamité Vous obtenez le maléfice <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'X8PSYw6WC2ePYSXd'})\">Malédiction titubante</div> et votre familier apprend <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': '6ZIKB0151LUR19Rw'})\">Mauvais présage</div> .",
                    "Vous pouvez choisir parmi ces leçons lorsqu'un don ou un autre effet vous accorde une leçon supérieure.",
                    "Leçon d'ombre Une ombre est loin d'être inutile : elle contient quelque chose de la personne qui la projette. Vous obtenez le maléfice <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'vhMCd15ZwNJn0zen'})\">Ombre malicieuse</div> et votre familier apprend <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'sRfSBHWHdbIa0aGc'})\">Ténèbres glaciales</div> .",
                    "Leçon de faveurs Vous obtenez le maléfice <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': '9gMQPCaFM27PEIh4'})\">Rendre la faveur</div> et votre familier apprend <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'fPlFRu4dp09qJs3K'})\">Esprit de menace</div> .",
                    "Leçon de malice Il n'y a rien de mal à faire quelques bêtises, de temps à autre. Vous obtenez le maléfice <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'FrKPwgFxWIGMGgs4'})\">Cape de tromperie</div> et votre familier apprend <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'tFKJCPvOQZxKq6ON'})\">Singes fous</div> .",
                    "Leçon de neige Imitez la neige, car elle peut étouffer la vie malgré sa douceur. Vous obtenez le maléfice <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'g4MAIQodRDVfNp1B'})\">Blizzard personnel</div> et votre familier apprend <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'it4ZsAi6XgvGcodc'})\">Mur de vent</div> .",
                    "Leçon de pourriture Toutes les choses vivantes finissent par pourrir, nourrissant les champignons et les insectes. Vous obtenez le maléfice <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'V4jrHiaMh4XuANOP'})\">Maladie mycologique</div> et votre familier apprend <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'XI6Lzd2B5pernkPd'})\">Forme d'insecte</div> .",
                    "Leçon du squale Vous apprenez les manières de ce prédateur océanique mortel. Vous obtenez le maléfice <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'CXpOlv2ZZq2jVbRX'})\">Sang dans l'eau</div> et votre familier apprend <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'RvBlSIJmxiqfCpR9'})\">Pieds en nageoires</div> .",
                    "Leçon du troupeau La puissance afflue lorsque plusieurs travaillent comme un seul. Vous obtenez le maléfice <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'gxK5XW4WAXOgY1mN'})\">Ailes protectrices</div> et votre familier apprend <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'fI20AVwOzJMHXRdo'})\">Lévitation</div> .",
                    "peu courant"
                ]
            },
            "lecons_majeures": {
                ...
                "description": [
                    ...
                    "Leçon de marchandage Vous obtenez le maléfice <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'PcmFpaHPCReNp1BD'})\">Sur des charbons ardents</div> et votre familier apprend <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'GP3wewkQXEPrLxYj'})\">Suggestion subconsciente</div> .",
                    "Leçon de mort La mort est définitive, mais pas aussi inéluctable qu'il n'y paraît. Vous obtenez le maléfice <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'nQS4vPm5zprqkzFZ'})\">Malédiction de mort</div> et votre familier apprend <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'IkGYwHRLhkuoGReG'})\">Rappel à la vie</div> .",
                    "Leçon de renouveau L'entropie s'abat sur tous, mais il est possible de l'enrayer au prix d'un effort. Vous obtenez le maléfice <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'pCvJ4yoZJxDtgUMI'})\">Moment restauratif</div> et votre familier apprend <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'x5rGOmhDRDVQPrnW'})\">Champ de vie</div> .",
                    "Rare",
                    "Leçon de la reine glacée Vous obtenez le maléfice <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'ZyREiMaul0VhDYh3'})\">Cœur glacial</div> et votre familier apprend <div class=\"gs-link-information\" onclick=\"CONTROLLER.Main.doActionAfter('event__show_information', {'param__object__uuid': 'R5FHRv7VqyRnxg2t'})\">Mur de glace</div> ."
                ]
            }
        }
    }
