"use strict";
/**
 * @class CLASSES.Skills
 * @extends CHARACTER.ComponentInterfaceInput
 */
CLASSES.Skills = function () {
    this.init();
};
CLASSES.Skills.prototype = {
    init                    : function () {
        this.setKey( "class_skills" );
        this.setLabelProperty( "Class skills" );
    },
...
SERVICE.CLASS.addPrototype( CLASSES.Skills, CHARACTER.ComponentInterfaceInput );