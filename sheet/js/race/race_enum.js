  ...
  "results": {
    "18xDKYPDBLEv2myX": {
      ...
      "general_desc": [
        ...
        "Vous pourriez... : <li>Être grégaire et prompt à trouver une compagnie qui vous soit propre.</li><li>Absorber avec voracité les pratiques de ceux qui vous entourent, quelque fois même en oubliant d'où elles proviennent.</li>",
        "Les autres : <li>Sont troublés par votre respect et votre dédain simultanés des traditions.</li><li>Ont du mal à lire vos expressions ou vous regardent avec suspicion et superstition.</li>"
      ],
      "href": "/ancestries/18xDKYPDBLEv2myX",
      "id": "18xDKYPDBLEv2myX",
      "language": [
        "Commun",
        "Tengu"
      ...
      "language_sup": [
        "égal à votre modificateur d'Intelligence (s'il est positif). Choisissez parmi elfe",
        "fée",
        "halfelin",
        "gnomien",
    ...
    "7oQxL6wgsokD3QXG": {
      ...
      "general_desc": [
        ...
        "Vous pourriez... : <li>Analyser votre environnement, toujours à la recherche des embuscades, des terrains avantageux et de chemins pour déguerpir.</li><li>Observer, adopter et respecter naturellement les dynamiques de groupe, que ce soit comme dirigeant, subordonné ou comme égal.</li>",
        "Les autres : <li>Partent du principe que vous êtes couard et n'allez pas tenir votre place face au danger.</li><li>Apprécient votre ingéniosité et votre capacité à trouver des ressources, plus particulièrement lorsqu'il s'agit de concevoir des moyens de défense.</li>"
      ],
      "href": "/ancestries/7oQxL6wgsokD3QXG",
      "id": "7oQxL6wgsokD3QXG",
      "language": [
        "Commun",
        "sakvroth"
      ...
      "language_sup": [
        "égal à votre modificateur d'Intelligence (s'il est positif). Choisissez parmi aklo",
        "diabolique",
        "draconique",
        "empyréen",
        "fée",
    ...
    "972EkpJOPv9KkQIW": {
      ...
      "general_desc": [
        ...
        "Vous pourriez... : <li>Démontrer un intérêt véritable en posant beaucoup de questions enthousiastes.</li><li>Éviter le conflit interpersonnel en snobant l'autre ou simplement en quittant la zone.</li>",
        "Les autres : <li>Pensent que vous monopolisez les conversations avec vos questionnements incessants ou l'expression de vos opinions.</li><li>Vous attribuent plus d'émotion que vous n'en ressentez lorsque vous feulez ou ronronnez de manière involontaire.</li>"
      ],
      "href": "/ancestries/972EkpJOPv9KkQIW",
      "id": "972EkpJOPv9KkQIW",
      "language": [
        "Amurrun",
        "Commun"
      ...
      "language_sup": [
        "égal à votre modificateur d'Intelligence modifier (s'il est positif). Choisissez parmi draconique",
        "elfique",
        "gnomien",
        "gobelin",
        "halfelin",
    ...
    "BYj5ZvlXZdpaEgA6": {
      ...
      "general_desc": [
        "Les nains ont acquis la réputation bien méritée de peuple sévère et stoïque mais ils font aussi preuve d'un zèle effréné et accordent une grande importance à l'artisanat. Aux yeux d'un étranger, ils peuvent sembler méfiants et claniques, mais aux yeux de leurs amis et de leur famille, ils sont chaleureux et pleins d'attentions. Bien qu'il soit difficile de gagner la confiance d'un nain, une fois obtenue, elle est aussi solide que l'acier.",
        ...
        "Vous : <li>Vous efforcez de préserver votre honneur personnel et refusez de reculer.</li><li>Appréciez l'artisanat de qualité sous toutes ses formes et insistez pour que ce soit la norme pour tout votre équipement.</li>",
        "Les autres : <li>Vous considèrent comme têtu, bien que le fait que ce soit tantôt un atout tantôt un inconvénient varie d'un moment à l'autre.</li><li>Reconnaissent le profond lien qui vous unissent à votre famille, à votre héritage et à vos amis.</li>"
      ],
      "href": "/ancestries/BYj5ZvlXZdpaEgA6",
      "id": "BYj5ZvlXZdpaEgA6",
      "language": [
        "Commun",
        "Nain"
      ...
      "language_sup": [
        "égal à votre modificateur d'Intelligence (s'il est positif). Choisissez parmi gnomien",
        "gobelin",
        "jotun",
        "orquien",
        "pierreux",
    ...
    "CYlfsYLJcBOgqKtD": {
      ...
      "general_desc": [
        ...
        "Vous : <li>Adorez apprendre et sautez d'un centre d'intérêt à l'autre sans le moindre avertissement.</li><li>Parlez, pensez et vous déplacez rapidement et vous faites preuve de peu de patience pour ceux qui ne suivent pas le rythme.</li>",
        "Les autres : <li>Apprécient votre enthousiasme et l'énergie dont vous faites preuve face aux nouvelles situations.</li><li>Luttent pour comprendre vos motivations ou s'adapter à vos brusques changements de direction.</li>"
      ],
      "href": "/ancestries/CYlfsYLJcBOgqKtD",
      "id": "CYlfsYLJcBOgqKtD",
      "language": [
        "Commun",
        "Gnomien",
      ...
      "language_sup": [
        "égal à votre modificateur d'Intelligence (s'il est positif). Choisissez parmi Draconique",
        "Nain",
        "Elfique",
        "Gobelin",
        "Jotun",
    ...
    "GgZAHbrjnzWOZy2v": {
      ...
      "general_desc": [
        ...
        "Vous : <li>Vous entendez bien avec une grande variété de gens et vous réjouissez de rencontrer de nouveaux amis.</li><li>Trouvez difficile de ne pas satisfaire votre curiosité, même lorsque vous savez que cela va vous conduire à des ennuis.</li>",
        "Les autres : <li>apprécient votre capacité à toujours trouver un côté positif ou une raison de rire, quelle que soit la gravité de la situation.</li><li>Pensent que vous attirez la chance.</li>"
      ],
      "href": "/ancestries/GgZAHbrjnzWOZy2v",
      "id": "GgZAHbrjnzWOZy2v",
      "language": [
        "Commun",
        "Halfelin"
      ...
      "language_sup": [
        "égal à votre modificateur d'Intelligence (s'il est positif). Choisissez parmi Nain",
        "Elfique",
        "Gnomien",
        "Gobelin"
      ],
    ...
    "HWEgF7Gmoq55VhTL": {
      ...
      "general_desc": [
        ...
        "Vous pourriez... : <li>Tenir l'histoire de votre peuple en haute estime et chercher dans le passé des solutions aux problèmes du présent.</li><li>Lutter pour vous adapter à votre environnement tout en préservant votre culture et vos coutumes.</li>",
        "Les autres : <li>Partent du principe que vous êtes ancré dans votre tradition et que vous détenez d'anciennes connaissances.</li><li>Vous voient comme une créature impitoyable au sang-froid du fit de vos réactions physiques discrètes.</li>"
      ],
      "href": "/ancestries/HWEgF7Gmoq55VhTL",
      "id": "HWEgF7Gmoq55VhTL",
      "language": [
        "Commun",
        "Iruxi"
      ...
      "language_sup": [
        "égal à votre modificateur d'Intelligence (s'il est positif). Choisissez parmi amurrun",
        "aquatique",
        "bourbiérin",
        "draconique",
        "elfique",
    ...
    "IiG7DgeLWYrSNXuX": {
      "Ethnies": [
        ...
        "Les garundais couvrent les nations situées sur les rives méridionales de la Mer Intérieure. Les kéléshites sont originaires de l'empire kéléshite, dans les déserts de l'est. Les kellides vivent au sein des montagnes et des steppes du nord de l'Avistan. Les mwangis sont répartis sur le vaste continent du Garund. Les shoantis ont établi leur foyer dans les terres inhospitalières du Plateau de Storval. Les taldoriens occupent l'essentiel de l'Avistan du fait d'un Empire déchu. Les tianais viennent à l'origine du lointain continent du Tian Xia. Les ulfes résident dans les villes côtières de l'Avistant del'ouest. Les varisiens ont privilégié historiquement une vie nomade de caravane itinérantes."
      ],
      "believe_desc": [
      ...
      "general_desc": [
        ...
        "Vous : <li>Vous efforcez d'atteindre l'excellence, soit pour vous-même, soit pour défendre une cause.</li><li>Chérissez les relations entretenues avec votre famille et vos amis.</li>",
        "Les autres : <li>Respectent votre flexibilité, votre adaptabilité et, dans la plupart des cas, votre ouverture d'esprit.</li><li>Doutent de vos intentions, craignant que vous ne puissiez chercher qu'à accumuler du pouvoir ou la fortune.</li><li>Ne savent pas quoi penser de vous et hésitent à présumer vos intentions.</li>"
      ],
      "href": "/ancestries/IiG7DgeLWYrSNXuX",
      "id": "IiG7DgeLWYrSNXuX",
      "language": [
        "Commun"
      ],
      "language_sup": [
        "égale à 1 + votre modificateur d'Intelligence (s'il est positif). Choisissez parmi la liste des langues courantes et parmi toutes les langues auxquelles vous avez accès (telles que les langues prévalentes dans votre région)."
      ],
      "legacies": [
        "Humain polyvalent",
        "Héritage talentueux",
        "Humain touché par l'hiver",
        "Ces héritages proviennent de la Boite d'initiation et accordent des héritages non standards",
        "Humain entraîné à la bataille (BI)",
        "Humain gardien (BI)",
        "Aiuvarin",
        "Dromaar"
      ],
      "mechanic": [
        "Traits Humain, humanoïde"
      ],
      "name": "Humain",
      "noms": [],
      "physical_desc": [
    ...
    "P6PcVnCkh4XMdefw": {
      ...
      "general_desc": [
        ...
        "Vous pourriez... : <li>Tirer fierté de votre immense famille étendue et rester en contact avec tout un chacun en son sein.</li><li>Aimer voyager ici et là à la recherche de nouvelles expériences, en adorant collectionner les babioles au long du chemin.</li>",
        "Les autres : <li>Sont surpris par votre toilettage soigneux et vos autres habitudes maniaques.</li><li>Pensent que vous êtes collant et que vous envahissez leur espace personnel.</li>"
      ],
      "href": "/ancestries/P6PcVnCkh4XMdefw",
      "id": "P6PcVnCkh4XMdefw",
      "language": [
        "Commun",
        "Ysoki"
    ...
    "PgKmsA2aKdbLU6O0": {
      ...
      "general_desc": [
        ...
        "Vous : <li>Faites preuve de prudence dans vos relations avec les individus à l'espérance de vie plus courte.</li><li>Développez des centres d'intérêt spécialisés ou obscurs, dans l'objectif de les maîtriser.</li>",
        "Les autres : <li>Se concentrent généralement sur votre apparence et admirent votre grâce ou vous traitent comme si vous étiez physiquement fragile.</li><li>Craignent que vous les méprisiez dans votre for intérieur ou ont le sentiment que vous êtes condescendant ou réservé.</li>"
      ],
      "href": "/ancestries/PgKmsA2aKdbLU6O0",
      "id": "PgKmsA2aKdbLU6O0",
      "language": [
        "Commun",
        "Elfique"
    ...
    "cdhgByGG1WtuaK73": {
      ...
      "general_desc": [
        ...
        "Vous : <li>Agissez en tant qu'agent itinérant pour les gardiens de la nature incapables de quitter leurs territoires.</li><li>Encouragez les civilisations que vous rencontrez à agir en coopération avec la nature et construire leurs villes dans le respect de l'écologie.</li>",
        "Les autres : <li>pensent que vous êtes une curiosité du fait de vos origines spirituelles.</li><li>Pensent que vous ne connaissez que ce qui a trait à la nature et que vous ignorez tout de la civilisation et de la société.</li>"
      ],
      "href": "/ancestries/cdhgByGG1WtuaK73",
      "id": "cdhgByGG1WtuaK73",
      "language": [
        "Commun",
        "fée"
    ...
    "hXM5jXezIki1cMI2": {
      ...
      "general_desc": [
        ...
        "Vous pourriez... : <li>Rechercher des moyens astucieux d'exploiter votre environnement pour surmonter les difficultés.</li><li>Vous faire des amis lentement, préoccupé par les récits édifiants d'étrangers exploiteurs.</li>",
        "Les autres : <li>Font confiance à votre approche impartiale et mesurée pour comprendre les situations et résoudre les problèmes.</li><li>S'écartent de vous craignant que vous toucher puisse s'avérer toxique.</li>"
      ],
      "href": "/ancestries/hXM5jXezIki1cMI2",
      "id": "hXM5jXezIki1cMI2",
      "language": [
        "Commun",
        "tripkee"
      ...
      "language_sup": [
        "égal à votre modificateur d'Intelligence (s'il est positif). Choisissez parmi bourbiérin",
        "chthonien",
        "draconique",
        "elfique",
        "fée",
    ...
    "lSGWXjcbOa6O5fTx": {
      ...
      "general_desc": [
        ...
        "Vous pourriez... : <li>Attendre impatiemment n'importe quelle chance de prouver votre force dans un défi physique.</li><li>Penser que mourir lors d'un combat glorieux est préférable à une mort de vieillesse ou de maladie.</li>",
        "Les autres : <li>Vous voient comme violent ou manquant de discipline.</li><li>Admirent votre franc-parler et votre franche honnêteté.</li>"
      ],
      "href": "/ancestries/lSGWXjcbOa6O5fTx",
      "id": "lSGWXjcbOa6O5fTx",
      "language": [
        "Commun",
        "Orquien"
      ...
      "language_sup": [
        "égal à votre modificateur d'Intelligence (s'il est positif). Choisissez parmi gobelin",
        "jotun",
        "pierreux",
        "sakvroth"
      ],
    ...
    "piNLXUrm9iaGqD2i": {
      ...
      "general_desc": [
        ...
        "Vous pourriez... : <li>Chercher les solutions les plus efficaces et pragmatiques à tout problème.</li><li>Favoriser une chaîne de commandement bien définie au sein du groupe avec lequel vous voyagez, en suivant les ordres même si vous n'êtes pas d'accord avec eux.</li>",
        "Les autres : <li>Vous considèrent comme dangereux, à cause de votre réputation et de votre apparence intimidante.</li><li>Reconnaissent votre endurance, votre dévouement et votre rigueur incroyables.</li>"
      ],
      "href": "/ancestries/piNLXUrm9iaGqD2i",
      "id": "piNLXUrm9iaGqD2i",
      "language": [
        "Commun",
        "Gobelin"
    ...
    "sQfjTMDaZbT9DThq": {
      ...
      "general_desc": [
        ...
        "Vous : <li>Vous efforcez de prouver aux autres, et peut-être à vous-même, que vous avez votre place parmi les autres peuples civilisés.</li><li>Savez alléger la charge mentale que les autres ressentent (et vous amuser) avec vos farces et vos bouffonneries.</li>",
        "Les autres : <li>Font attention à ce que vous ne mettiez pas accidentellement (ou intentionnellement) le feu à trop de choses.</li><li>Se demandent comment vous avez pu survivre étant donné l'alimentation, l'imprudence et la passion pour le feu qui sont caractéristiques de votre ascendance.</li>"
      ],
      "href": "/ancestries/sQfjTMDaZbT9DThq",
      "id": "sQfjTMDaZbT9DThq",
      "language": [
        "Commun",
        "Gobelin"
    ...
    "vxbQ1Yw4qwgjTzqo": {
      ...
      "believe_desc": [
        ...
        "Édits populaires",
        "renforcer vos alliés et votre meute, reconter les contes de vos ancêtres, neutraliser les ennemis avec des tactiques et la ruse",
        "Anathème populaire",
      ...
      "general_desc": [
        "Les kholos ont la mauvaise réputation de pillards brutaux et de suivants de fidèles. Nombreux croient que les kholos sont des sorciers, des cannibales et pire. La vérité est plus complexe.",
        ...
        "Vous pourriez... : <li>Être très démonstratif physiquement - en étreignant, en frappant ou en léchant vos amis.</li><li>Conserver un os d'un parent révéré pour lui demander conseil.</li>",
        "Les autres : <li>Sont intimidés par votre taille, vos dents et votre rire lugubre.</li><li>Respectent l'efficacité brutale de votre style de chasse.</li>"
      ],
      "href": "/ancestries/vxbQ1Yw4qwgjTzqo",
      "id": "vxbQ1Yw4qwgjTzqo",
      "language": [
        "Commun",
        "Kholo"
  ...
  "links": {
    "heritages": {
      ...
      "d7NC4C19AgkspQQg": {
        ...
        "id": "d7NC4C19AgkspQQg",
        "name": "Humain entraîné à la bataille (BI)"
      },
      "dJeiekfqGQ8dkwsO": {
        "category": "heritages",
      ...
      "hOPOyyt7qZXYYCOU": {
        ...
        "id": "hOPOyyt7qZXYYCOU",
        "name": "Homme-félin aux neufs vies"
      },
      "hTl3uc6y1kTuo9ac": {
        "category": "heritages",
